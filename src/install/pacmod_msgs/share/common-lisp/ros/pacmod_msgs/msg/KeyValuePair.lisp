...
(cl:defmethod cl:initialize-instance :after ((m <KeyValuePair>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'KeyValuePair)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pacmod_msgs-msg:<KeyValuePair> is deprecated: use pacmod_msgs-msg:KeyValuePair instead.")))

(cl:ensure-generic-function 'key-val :lambda-list '(m))
(cl:defmethod key-val ((m <KeyValuePair>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pacmod_msgs-msg:key-val is deprecated.  Use pacmod_msgs-msg:key instead.")
  (key m))

(cl:ensure-generic-function 'value-val :lambda-list '(m))
(cl:defmethod value-val ((m <KeyValuePair>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pacmod_msgs-msg:value-val is deprecated.  Use pacmod_msgs-msg:value instead.")
  (value m))
