...
bool operator==(const ::pacmod_msgs::GlobalRpt_<ContainerAllocator1> & lhs, const ::pacmod_msgs::GlobalRpt_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.enabled == rhs.enabled &&
    lhs.override_active == rhs.override_active &&
    lhs.fault_active == rhs.fault_active &&
    lhs.config_fault_active == rhs.config_fault_active &&
    lhs.user_can_timeout == rhs.user_can_timeout &&
    lhs.brake_can_timeout == rhs.brake_can_timeout &&
    lhs.steering_can_timeout == rhs.steering_can_timeout &&
    lhs.vehicle_can_timeout == rhs.vehicle_can_timeout &&
    lhs.subsystem_can_timeout == rhs.subsystem_can_timeout &&
    lhs.user_can_read_errors == rhs.user_can_read_errors;
}
