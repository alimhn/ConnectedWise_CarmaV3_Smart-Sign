...
bool operator==(const ::pacmod_msgs::DetectedObjectRpt_<ContainerAllocator1> & lhs, const ::pacmod_msgs::DetectedObjectRpt_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.front_object_distance_low_res == rhs.front_object_distance_low_res &&
    lhs.front_object_distance_high_res == rhs.front_object_distance_high_res;
}
