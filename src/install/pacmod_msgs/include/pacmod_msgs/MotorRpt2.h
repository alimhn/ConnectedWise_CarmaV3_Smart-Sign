...
bool operator==(const ::pacmod_msgs::MotorRpt2_<ContainerAllocator1> & lhs, const ::pacmod_msgs::MotorRpt2_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.encoder_temp == rhs.encoder_temp &&
