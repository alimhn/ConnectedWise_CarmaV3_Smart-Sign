...
bool operator==(const ::pacmod_msgs::PacmodCmd_<ContainerAllocator1> & lhs, const ::pacmod_msgs::PacmodCmd_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.f64_cmd == rhs.f64_cmd &&
    lhs.ui16_cmd == rhs.ui16_cmd &&
