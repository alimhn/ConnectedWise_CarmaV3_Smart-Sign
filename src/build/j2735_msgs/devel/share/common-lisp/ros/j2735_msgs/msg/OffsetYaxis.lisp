...
;//! \htmlinclude OffsetYaxis.msg.html

(cl:defclass <OffsetYaxis> (roslisp-msg-protocol:ros-message)
  ((choice
    :reader choice
    :initarg :choice
    :type cl:fixnum
...
(cl:defclass OffsetYaxis (<OffsetYaxis>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <OffsetYaxis>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'OffsetYaxis)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name j2735_msgs-msg:<OffsetYaxis> is deprecated: use j2735_msgs-msg:OffsetYaxis instead.")))

(cl:ensure-generic-function 'choice-val :lambda-list '(m))
(cl:defmethod choice-val ((m <OffsetYaxis>))
...
(cl:defmethod small-val ((m <OffsetYaxis>))
...
(cl:defmethod large-val ((m <OffsetYaxis>))
  ...
  (large m))
(cl:defmethod roslisp-msg-protocol:symbol-codes ((msg-type (cl:eql '<OffsetYaxis>)))
    "Constants for message type '<OffsetYaxis>"
  '((:SMALL . 0)
    (:LARGE . 1))
)
(cl:defmethod roslisp-msg-protocol:symbol-codes ((msg-type (cl:eql 'OffsetYaxis)))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <OffsetYaxis>) ostream)
  "Serializes a message object of type '<OffsetYaxis>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <OffsetYaxis>) istream)
  "Deserializes a message object of type '<OffsetYaxis>"
