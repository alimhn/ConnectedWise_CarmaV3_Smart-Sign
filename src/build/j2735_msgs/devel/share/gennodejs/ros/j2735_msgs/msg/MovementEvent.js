...
class MovementEvent {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.timing = null;
      this.timing_exists = null;
      this.speeds = null;
      this.speeds_exists = null;
    }
    else {
      if (initObj.hasOwnProperty('event_state')) {
        ...
        this.event_state = new MovementPhaseState();
      }
      ...
      if (initObj.hasOwnProperty('timing_exists')) {
        this.timing_exists = initObj.timing_exists
      }
      else {
      ...
      if (initObj.hasOwnProperty('speeds_exists')) {
        this.speeds_exists = initObj.speeds_exists
      }
      else {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type MovementEvent
    // Serialize message field [event_state]
    bufferOffset = MovementPhaseState.serialize(obj.event_state, buffer, bufferOffset);
    // Serialize message field [timing]
    bufferOffset = TimeChangeDetails.serialize(obj.timing, buffer, bufferOffset);
    // Serialize message field [timing_exists]
    bufferOffset = _serializer.bool(obj.timing_exists, buffer, bufferOffset);
    // Serialize message field [speeds]
    bufferOffset = AdvisorySpeedList.serialize(obj.speeds, buffer, bufferOffset);
    // Serialize message field [speeds_exists]
    bufferOffset = _serializer.bool(obj.speeds_exists, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type MovementEvent
    let len;
    let data = new MovementEvent(null);
    // Deserialize message field [event_state]
    data.event_state = MovementPhaseState.deserialize(buffer, bufferOffset);
    // Deserialize message field [timing]
    data.timing = TimeChangeDetails.deserialize(buffer, bufferOffset);
    // Deserialize message field [timing_exists]
    data.timing_exists = _deserializer.bool(buffer, bufferOffset);
    // Deserialize message field [speeds]
    data.speeds = AdvisorySpeedList.deserialize(buffer, bufferOffset);
    // Deserialize message field [speeds_exists]
    data.speeds_exists = _deserializer.bool(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += AdvisorySpeedList.getMessageSize(object.speeds);
    return length + 19;
  }

  static datatype() {
    // Returns string type for a message object
    return 'j2735_msgs/MovementEvent';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '761599329944c7cfb6a4fdf84a54a500';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MovementEvent(null);
    if (msg.event_state !== undefined) {
      resolved.event_state = MovementPhaseState.Resolve(msg.event_state)
    }
    else {
      resolved.event_state = new MovementPhaseState()
    }

    if (msg.timing !== undefined) {
      resolved.timing = TimeChangeDetails.Resolve(msg.timing)
    }
    else {
      resolved.timing = new TimeChangeDetails()
    }

    if (msg.timing_exists !== undefined) {
      resolved.timing_exists = msg.timing_exists;
    }
    else {
      resolved.timing_exists = false
    }

    if (msg.speeds !== undefined) {
      resolved.speeds = AdvisorySpeedList.Resolve(msg.speeds)
    }
    else {
      resolved.speeds = new AdvisorySpeedList()
    }

    if (msg.speeds_exists !== undefined) {
      resolved.speeds_exists = msg.speeds_exists;
    }
    else {
      resolved.speeds_exists = false
    }
