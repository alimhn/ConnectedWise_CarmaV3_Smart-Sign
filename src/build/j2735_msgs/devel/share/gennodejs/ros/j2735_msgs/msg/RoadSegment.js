...
class RoadSegment {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('road_lane_set')) {
        this.road_lane_set = initObj.road_lane_set
      }
      else {
        this.road_lane_set = new RoadLaneSetList();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = RoadSegmentReferenceID.serialize(obj.id, buffer, bufferOffset);
    ...
    // Serialize message field [road_lane_set]
    bufferOffset = RoadLaneSetList.serialize(obj.road_lane_set, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [road_lane_set]
    data.road_lane_set = RoadLaneSetList.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += RoadLaneSetList.getMessageSize(object.road_lane_set);
    return length + 37;
  }

  static datatype() {
    // Returns string type for a message object
    return 'j2735_msgs/RoadSegment';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '9299db39f63085d859ce33cb3ccd2ca7';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new RoadSegment(null);
    ...
    if (msg.id !== undefined) {
      resolved.id = RoadSegmentReferenceID.Resolve(msg.id)
    }
    else {
      resolved.id = new RoadSegmentReferenceID()
    }
    ...
    if (msg.road_lane_set !== undefined) {
      resolved.road_lane_set = RoadLaneSetList.Resolve(msg.road_lane_set)
    }
    else {
      resolved.road_lane_set = new RoadLaneSetList()
    }
