...
class NodeXY {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('attributes_exists')) {
        this.attributes_exists = initObj.attributes_exists
      }
      else {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type NodeXY
    // Serialize message field [delta]
    bufferOffset = NodeOffsetPointXY.serialize(obj.delta, buffer, bufferOffset);
    // Serialize message field [attributes]
    bufferOffset = NodeAttributeSetXY.serialize(obj.attributes, buffer, bufferOffset);
    // Serialize message field [attributes_exists]
    bufferOffset = _serializer.bool(obj.attributes_exists, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type NodeXY
    let len;
    let data = new NodeXY(null);
    // Deserialize message field [delta]
    data.delta = NodeOffsetPointXY.deserialize(buffer, bufferOffset);
    // Deserialize message field [attributes]
    data.attributes = NodeAttributeSetXY.deserialize(buffer, bufferOffset);
    // Deserialize message field [attributes_exists]
    data.attributes_exists = _deserializer.bool(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += NodeAttributeSetXY.getMessageSize(object.attributes);
    return length + 58;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new NodeXY(null);
    if (msg.delta !== undefined) {
      resolved.delta = NodeOffsetPointXY.Resolve(msg.delta)
    }
    else {
      resolved.delta = new NodeOffsetPointXY()
    }

    if (msg.attributes !== undefined) {
      resolved.attributes = NodeAttributeSetXY.Resolve(msg.attributes)
    }
    else {
      resolved.attributes = new NodeAttributeSetXY()
    }

    if (msg.attributes_exists !== undefined) {
      resolved.attributes_exists = msg.attributes_exists;
    }
    else {
      resolved.attributes_exists = false
    }
