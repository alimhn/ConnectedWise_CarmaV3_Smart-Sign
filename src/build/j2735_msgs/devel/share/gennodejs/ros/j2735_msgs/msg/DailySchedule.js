...
class DailySchedule {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.uint16(obj.begin, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new DailySchedule(null);
    // Deserialize message field [begin]
    data.begin = _deserializer.uint16(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    const resolved = new DailySchedule(null);
