...
class IntersectionGeometry {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.lane_width_exists = null;
      this.speed_limits = null;
      this.speed_limits_exists = null;
      this.lane_set = null;
      this.preempt_priority_data = null;
      this.preempt_priority_data_exists = null;
    }
    else {
      ...
      if (initObj.hasOwnProperty('lane_width_exists')) {
        this.lane_width_exists = initObj.lane_width_exists
      }
      else {
      ...
      if (initObj.hasOwnProperty('speed_limits_exists')) {
        this.speed_limits_exists = initObj.speed_limits_exists
      }
      else {
        this.speed_limits_exists = false;
      }
      if (initObj.hasOwnProperty('lane_set')) {
        this.lane_set = initObj.lane_set
      }
      else {
        this.lane_set = new LaneList();
      }
      if (initObj.hasOwnProperty('preempt_priority_data')) {
        this.preempt_priority_data = initObj.preempt_priority_data
      }
      else {
        this.preempt_priority_data = new PreemptPriorityList();
      }
      if (initObj.hasOwnProperty('preempt_priority_data_exists')) {
        this.preempt_priority_data_exists = initObj.preempt_priority_data_exists
      }
      else {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type IntersectionGeometry
    ...
    bufferOffset = Position3D.serialize(obj.ref_point, buffer, bufferOffset);
    // Serialize message field [lane_width]
    bufferOffset = _serializer.uint16(obj.lane_width, buffer, bufferOffset);
    // Serialize message field [lane_width_exists]
    bufferOffset = _serializer.bool(obj.lane_width_exists, buffer, bufferOffset);
    // Serialize message field [speed_limits]
    bufferOffset = SpeedLimitList.serialize(obj.speed_limits, buffer, bufferOffset);
    // Serialize message field [speed_limits_exists]
    bufferOffset = _serializer.bool(obj.speed_limits_exists, buffer, bufferOffset);
    // Serialize message field [lane_set]
    bufferOffset = LaneList.serialize(obj.lane_set, buffer, bufferOffset);
    // Serialize message field [preempt_priority_data]
    bufferOffset = PreemptPriorityList.serialize(obj.preempt_priority_data, buffer, bufferOffset);
    // Serialize message field [preempt_priority_data_exists]
    bufferOffset = _serializer.bool(obj.preempt_priority_data_exists, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type IntersectionGeometry
    let len;
    let data = new IntersectionGeometry(null);
    ...
    data.ref_point = Position3D.deserialize(buffer, bufferOffset);
    // Deserialize message field [lane_width]
    data.lane_width = _deserializer.uint16(buffer, bufferOffset);
    // Deserialize message field [lane_width_exists]
    data.lane_width_exists = _deserializer.bool(buffer, bufferOffset);
    // Deserialize message field [speed_limits]
    data.speed_limits = SpeedLimitList.deserialize(buffer, bufferOffset);
    // Deserialize message field [speed_limits_exists]
    data.speed_limits_exists = _deserializer.bool(buffer, bufferOffset);
    // Deserialize message field [lane_set]
    data.lane_set = LaneList.deserialize(buffer, bufferOffset);
    // Deserialize message field [preempt_priority_data]
    data.preempt_priority_data = PreemptPriorityList.deserialize(buffer, bufferOffset);
    // Deserialize message field [preempt_priority_data_exists]
    data.preempt_priority_data_exists = _deserializer.bool(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += LaneList.getMessageSize(object.lane_set);
    length += PreemptPriorityList.getMessageSize(object.preempt_priority_data);
    return length + 37;
  }

  static datatype() {
    // Returns string type for a message object
    return 'j2735_msgs/IntersectionGeometry';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '6f400b684334789a1612b10175af16ae';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new IntersectionGeometry(null);
    ...
    if (msg.ref_point !== undefined) {
      resolved.ref_point = Position3D.Resolve(msg.ref_point)
    }
    else {
      resolved.ref_point = new Position3D()
    }
    ...
    if (msg.lane_width !== undefined) {
      ...
      resolved.lane_width = 0
    }

    if (msg.lane_width_exists !== undefined) {
      resolved.lane_width_exists = msg.lane_width_exists;
    }
    else {
      resolved.lane_width_exists = false
    }
    ...
    if (msg.speed_limits_exists !== undefined) {
      resolved.speed_limits_exists = msg.speed_limits_exists;
    }
    else {
      resolved.speed_limits_exists = false
    }

    if (msg.lane_set !== undefined) {
      resolved.lane_set = LaneList.Resolve(msg.lane_set)
    }
    else {
      resolved.lane_set = new LaneList()
    }

    if (msg.preempt_priority_data !== undefined) {
      resolved.preempt_priority_data = PreemptPriorityList.Resolve(msg.preempt_priority_data)
    }
    else {
      resolved.preempt_priority_data = new PreemptPriorityList()
    }

    if (msg.preempt_priority_data_exists !== undefined) {
      resolved.preempt_priority_data_exists = msg.preempt_priority_data_exists;
    }
    else {
      resolved.preempt_priority_data_exists = false
    }
...
module.exports = IntersectionGeometry;
