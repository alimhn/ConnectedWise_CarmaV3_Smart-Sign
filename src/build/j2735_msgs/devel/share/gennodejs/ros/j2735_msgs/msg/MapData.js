...
class MapData {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.msg_issue_revision = null;
      this.layer_type = null;
      this.layer_id = null;
      this.layer_id_exists = null;
      this.intersections = null;
      this.intersections_exists = null;
      this.road_segments = null;
      this.road_segments_exists = null;
      this.data_parameters = null;
      this.data_parameters_exists = null;
      this.restriction_list = null;
      this.restriction_list_exists = null;
    }
    else {
      ...
      if (initObj.hasOwnProperty('msg_issue_revision')) {
        this.msg_issue_revision = initObj.msg_issue_revision
      }
      else {
      ...
      if (initObj.hasOwnProperty('layer_id_exists')) {
        this.layer_id_exists = initObj.layer_id_exists
      }
      else {
      ...
      if (initObj.hasOwnProperty('intersections_exists')) {
        this.intersections_exists = initObj.intersections_exists
      }
      else {
        this.intersections_exists = false;
      }
      if (initObj.hasOwnProperty('road_segments')) {
        this.road_segments = initObj.road_segments
      }
      else {
        this.road_segments = new RoadSegmentList();
      }
      if (initObj.hasOwnProperty('road_segments_exists')) {
        this.road_segments_exists = initObj.road_segments_exists
      }
      else {
        this.road_segments_exists = false;
      }
      if (initObj.hasOwnProperty('data_parameters')) {
        this.data_parameters = initObj.data_parameters
      }
      else {
        this.data_parameters = new DataParameters();
      }
      if (initObj.hasOwnProperty('data_parameters_exists')) {
        this.data_parameters_exists = initObj.data_parameters_exists
      }
      else {
        this.data_parameters_exists = false;
      }
      if (initObj.hasOwnProperty('restriction_list')) {
        this.restriction_list = initObj.restriction_list
      }
      else {
        this.restriction_list = new RestrictionClassList();
      }
      if (initObj.hasOwnProperty('restriction_list_exists')) {
        this.restriction_list_exists = initObj.restriction_list_exists
      }
      else {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [msg_issue_revision]
    bufferOffset = _serializer.uint8(obj.msg_issue_revision, buffer, bufferOffset);
    // Serialize message field [layer_type]
    bufferOffset = LayerType.serialize(obj.layer_type, buffer, bufferOffset);
    // Serialize message field [layer_id]
    bufferOffset = _serializer.uint8(obj.layer_id, buffer, bufferOffset);
    // Serialize message field [layer_id_exists]
    bufferOffset = _serializer.bool(obj.layer_id_exists, buffer, bufferOffset);
    ...
    obj.intersections.forEach((val) => {
      bufferOffset = IntersectionGeometry.serialize(val, buffer, bufferOffset);
    });
    // Serialize message field [intersections_exists]
    bufferOffset = _serializer.bool(obj.intersections_exists, buffer, bufferOffset);
    // Serialize message field [road_segments]
    bufferOffset = RoadSegmentList.serialize(obj.road_segments, buffer, bufferOffset);
    // Serialize message field [road_segments_exists]
    bufferOffset = _serializer.bool(obj.road_segments_exists, buffer, bufferOffset);
    // Serialize message field [data_parameters]
    bufferOffset = DataParameters.serialize(obj.data_parameters, buffer, bufferOffset);
    // Serialize message field [data_parameters_exists]
    bufferOffset = _serializer.bool(obj.data_parameters_exists, buffer, bufferOffset);
    // Serialize message field [restriction_list]
    bufferOffset = RestrictionClassList.serialize(obj.restriction_list, buffer, bufferOffset);
    // Serialize message field [restriction_list_exists]
    bufferOffset = _serializer.bool(obj.restriction_list_exists, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [msg_issue_revision]
    data.msg_issue_revision = _deserializer.uint8(buffer, bufferOffset);
    // Deserialize message field [layer_type]
    data.layer_type = LayerType.deserialize(buffer, bufferOffset);
    // Deserialize message field [layer_id]
    data.layer_id = _deserializer.uint8(buffer, bufferOffset);
    // Deserialize message field [layer_id_exists]
    data.layer_id_exists = _deserializer.bool(buffer, bufferOffset);
    ...
    for (let i = 0; i < len; ++i) {
      data.intersections[i] = IntersectionGeometry.deserialize(buffer, bufferOffset)
    }
    // Deserialize message field [intersections_exists]
    data.intersections_exists = _deserializer.bool(buffer, bufferOffset);
    // Deserialize message field [road_segments]
    data.road_segments = RoadSegmentList.deserialize(buffer, bufferOffset);
    // Deserialize message field [road_segments_exists]
    data.road_segments_exists = _deserializer.bool(buffer, bufferOffset);
    // Deserialize message field [data_parameters]
    data.data_parameters = DataParameters.deserialize(buffer, bufferOffset);
    // Deserialize message field [data_parameters_exists]
    data.data_parameters_exists = _deserializer.bool(buffer, bufferOffset);
    // Deserialize message field [restriction_list]
    data.restriction_list = RestrictionClassList.deserialize(buffer, bufferOffset);
    // Deserialize message field [restriction_list_exists]
    data.restriction_list_exists = _deserializer.bool(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.intersections.forEach((val) => {
      length += IntersectionGeometry.getMessageSize(val);
    });
    length += RoadSegmentList.getMessageSize(object.road_segments);
    length += DataParameters.getMessageSize(object.data_parameters);
    length += RestrictionClassList.getMessageSize(object.restriction_list);
    return length + 17;
  }

  static datatype() {
    // Returns string type for a message object
    return 'j2735_msgs/MapData';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '4a884ffcbb1d61cacd2b7304877db10b';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.msg_issue_revision !== undefined) {
      resolved.msg_issue_revision = msg.msg_issue_revision;
    }
    else {
      resolved.msg_issue_revision = 0
    }

    if (msg.layer_type !== undefined) {
      resolved.layer_type = LayerType.Resolve(msg.layer_type)
    }
    else {
      resolved.layer_type = new LayerType()
    }

    if (msg.layer_id !== undefined) {
      resolved.layer_id = msg.layer_id;
    }
    else {
      resolved.layer_id = 0
    }

    if (msg.layer_id_exists !== undefined) {
      resolved.layer_id_exists = msg.layer_id_exists;
    }
    else {
      resolved.layer_id_exists = false
    }
    ...
    if (msg.intersections !== undefined) {
      ...
      for (let i = 0; i < resolved.intersections.length; ++i) {
        resolved.intersections[i] = IntersectionGeometry.Resolve(msg.intersections[i]);
      }
    }
    else {
    ...
    if (msg.intersections_exists !== undefined) {
      resolved.intersections_exists = msg.intersections_exists;
    }
    else {
      resolved.intersections_exists = false
    }

    if (msg.road_segments !== undefined) {
      resolved.road_segments = RoadSegmentList.Resolve(msg.road_segments)
    }
    else {
      resolved.road_segments = new RoadSegmentList()
    }

    if (msg.road_segments_exists !== undefined) {
      resolved.road_segments_exists = msg.road_segments_exists;
    }
    else {
      resolved.road_segments_exists = false
    }

    if (msg.data_parameters !== undefined) {
      resolved.data_parameters = DataParameters.Resolve(msg.data_parameters)
    }
    else {
      resolved.data_parameters = new DataParameters()
    }

    if (msg.data_parameters_exists !== undefined) {
      resolved.data_parameters_exists = msg.data_parameters_exists;
    }
    else {
      resolved.data_parameters_exists = false
    }

    if (msg.restriction_list !== undefined) {
      resolved.restriction_list = RestrictionClassList.Resolve(msg.restriction_list)
    }
    else {
      resolved.restriction_list = new RestrictionClassList()
    }

    if (msg.restriction_list_exists !== undefined) {
      resolved.restriction_list_exists = msg.restriction_list_exists;
    }
    else {
      resolved.restriction_list_exists = false
    }
