...
class IntersectionState {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.status = null;
      this.moy = null;
      this.moy_exists = null;
      this.time_stamp = null;
      this.time_stamp_exists = null;
      this.enabled_lanes = null;
      this.enabled_lanes_exists = null;
      this.states = null;
      this.maneuever_assist_list = null;
      this.maneuever_assist_list_exists = null;
    }
    else {
      ...
      if (initObj.hasOwnProperty('moy_exists')) {
        this.moy_exists = initObj.moy_exists
      }
      else {
      ...
      if (initObj.hasOwnProperty('enabled_lanes')) {
        this.enabled_lanes = initObj.enabled_lanes
      }
      else {
        this.enabled_lanes = new EnabledLaneList();
      }
      if (initObj.hasOwnProperty('enabled_lanes_exists')) {
        this.enabled_lanes_exists = initObj.enabled_lanes_exists
      }
      else {
      ...
      if (initObj.hasOwnProperty('maneuever_assist_list')) {
        this.maneuever_assist_list = initObj.maneuever_assist_list
      }
      else {
        this.maneuever_assist_list = new ManeuverAssistList();
      }
      if (initObj.hasOwnProperty('maneuever_assist_list_exists')) {
        this.maneuever_assist_list_exists = initObj.maneuever_assist_list_exists
      }
      else {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type IntersectionState
    ...
    bufferOffset = IntersectionReferenceID.serialize(obj.id, buffer, bufferOffset);
    // Serialize message field [revision]
    bufferOffset = _serializer.uint8(obj.revision, buffer, bufferOffset);
    // Serialize message field [status]
    bufferOffset = IntersectionStatusObject.serialize(obj.status, buffer, bufferOffset);
    // Serialize message field [moy]
    bufferOffset = _serializer.uint32(obj.moy, buffer, bufferOffset);
    // Serialize message field [moy_exists]
    bufferOffset = _serializer.bool(obj.moy_exists, buffer, bufferOffset);
    ...
    // Serialize message field [enabled_lanes]
    bufferOffset = EnabledLaneList.serialize(obj.enabled_lanes, buffer, bufferOffset);
    // Serialize message field [enabled_lanes_exists]
    bufferOffset = _serializer.bool(obj.enabled_lanes_exists, buffer, bufferOffset);
    // Serialize message field [states]
    bufferOffset = MovementList.serialize(obj.states, buffer, bufferOffset);
    // Serialize message field [maneuever_assist_list]
    bufferOffset = ManeuverAssistList.serialize(obj.maneuever_assist_list, buffer, bufferOffset);
    // Serialize message field [maneuever_assist_list_exists]
    bufferOffset = _serializer.bool(obj.maneuever_assist_list_exists, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type IntersectionState
    let len;
    let data = new IntersectionState(null);
    // Deserialize message field [name]
    data.name = _deserializer.string(buffer, bufferOffset);
    // Deserialize message field [name_exists]
    data.name_exists = _deserializer.bool(buffer, bufferOffset);
    // Deserialize message field [id]
    data.id = IntersectionReferenceID.deserialize(buffer, bufferOffset);
    // Deserialize message field [revision]
    data.revision = _deserializer.uint8(buffer, bufferOffset);
    // Deserialize message field [status]
    data.status = IntersectionStatusObject.deserialize(buffer, bufferOffset);
    // Deserialize message field [moy]
    data.moy = _deserializer.uint32(buffer, bufferOffset);
    // Deserialize message field [moy_exists]
    data.moy_exists = _deserializer.bool(buffer, bufferOffset);
    ...
    // Deserialize message field [enabled_lanes]
    data.enabled_lanes = EnabledLaneList.deserialize(buffer, bufferOffset);
    // Deserialize message field [enabled_lanes_exists]
    data.enabled_lanes_exists = _deserializer.bool(buffer, bufferOffset);
    // Deserialize message field [states]
    data.states = MovementList.deserialize(buffer, bufferOffset);
    // Deserialize message field [maneuever_assist_list]
    data.maneuever_assist_list = ManeuverAssistList.deserialize(buffer, bufferOffset);
    // Deserialize message field [maneuever_assist_list_exists]
    data.maneuever_assist_list_exists = _deserializer.bool(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += EnabledLaneList.getMessageSize(object.enabled_lanes);
    length += MovementList.getMessageSize(object.states);
    length += ManeuverAssistList.getMessageSize(object.maneuever_assist_list);
    return length + 25;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new IntersectionState(null);
    ...
    if (msg.id !== undefined) {
      resolved.id = IntersectionReferenceID.Resolve(msg.id)
    }
    else {
      resolved.id = new IntersectionReferenceID()
    }
    ...
    if (msg.status !== undefined) {
      resolved.status = IntersectionStatusObject.Resolve(msg.status)
    }
    else {
      resolved.status = new IntersectionStatusObject()
    }
    ...
    if (msg.moy_exists !== undefined) {
      resolved.moy_exists = msg.moy_exists;
    }
    else {
      resolved.moy_exists = false
    }
    ...
    if (msg.enabled_lanes !== undefined) {
      resolved.enabled_lanes = EnabledLaneList.Resolve(msg.enabled_lanes)
    }
    else {
      resolved.enabled_lanes = new EnabledLaneList()
    }

    if (msg.enabled_lanes_exists !== undefined) {
      resolved.enabled_lanes_exists = msg.enabled_lanes_exists;
    }
    else {
      resolved.enabled_lanes_exists = false
    }

    if (msg.states !== undefined) {
      resolved.states = MovementList.Resolve(msg.states)
    }
    else {
      resolved.states = new MovementList()
    }

    if (msg.maneuever_assist_list !== undefined) {
      resolved.maneuever_assist_list = ManeuverAssistList.Resolve(msg.maneuever_assist_list)
    }
    else {
      resolved.maneuever_assist_list = new ManeuverAssistList()
    }

    if (msg.maneuever_assist_list_exists !== undefined) {
      resolved.maneuever_assist_list_exists = msg.maneuever_assist_list_exists;
    }
    else {
      resolved.maneuever_assist_list_exists = false
    }
...
IntersectionState.Constants = {
  MOY_INVALID: 527040,
  TIME_STAMP_UNAVAILABLE: 65535,
}

module.exports = IntersectionState;
