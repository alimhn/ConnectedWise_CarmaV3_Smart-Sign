...
"""autogenerated by genpy from j2735_msgs/MovementState.msg. Do not edit."""
import codecs
import sys
...
class MovementState(genpy.Message):
  _md5sum = "03f884cbb00c241dcbd9be968688be05"
  _type = "j2735_msgs/MovementState"
...
# regional #TODO: RegionalExtensions are not yet implemented in asn1c"""
  __slots__ = ['movement_name','movement_name_exists','signal_group','state_time_speed','maneuver_assist_list','maneuver_assist_list_exists']
  _slot_types = ['string','bool','uint8','j2735_msgs/MovementEventList','j2735_msgs/ManeuverAssistList','bool']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       movement_name,movement_name_exists,signal_group,state_time_speed,maneuver_assist_list,maneuver_assist_list_exists
    ...
    """
    if args or kwds:
      super(MovementState, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.movement_name is None:
        self.movement_name = ''
      if self.movement_name_exists is None:
        self.movement_name_exists = False
      if self.signal_group is None:
        self.signal_group = 0
      if self.state_time_speed is None:
        self.state_time_speed = j2735_msgs.msg.MovementEventList()
      if self.maneuver_assist_list is None:
        self.maneuver_assist_list = j2735_msgs.msg.ManeuverAssistList()
      if self.maneuver_assist_list_exists is None:
        self.maneuver_assist_list_exists = False
    else:
      self.movement_name = ''
      self.movement_name_exists = False
      self.signal_group = 0
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.state_time_speed.movement_event_list)
      buff.write(_struct_I.pack(length))
      for val1 in self.state_time_speed.movement_event_list:
        ...
        buff.write(_get_struct_B().pack(_x))
      length = len(self.maneuver_assist_list.connection_maneuver_assist_list)
      buff.write(_struct_I.pack(length))
      for val1 in self.maneuver_assist_list.connection_maneuver_assist_list:
        _x = val1
      ...
      _x = self.maneuver_assist_list_exists
      buff.write(_get_struct_B().pack(_x))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.movement_name = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.movement_name = str[start:end]
      _x = self
      start = end
      end += 2
      (_x.movement_name_exists, _x.signal_group,) = _get_struct_2B().unpack(str[start:end])
      self.movement_name_exists = bool(self.movement_name_exists)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.state_time_speed.movement_event_list = []
      for i in range(0, length):
        ...
        self.state_time_speed.movement_event_list.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.maneuver_assist_list.connection_maneuver_assist_list = []
      for i in range(0, length):
        ...
        self.maneuver_assist_list.connection_maneuver_assist_list.append(val1)
      start = end
      end += 1
      (self.maneuver_assist_list_exists,) = _get_struct_B().unpack(str[start:end])
      self.maneuver_assist_list_exists = bool(self.maneuver_assist_list_exists)
      return self
