...
"""autogenerated by genpy from j2735_msgs/RoadSegmentList.msg. Do not edit."""
import codecs
import sys
...
class RoadSegmentList(genpy.Message):
  _md5sum = "2db4607d141b80bd6f38916afcdd0403"
  _type = "j2735_msgs/RoadSegmentList"
...
uint16[] overlay_lane_list"""
  __slots__ = ['road_segment_list']
  _slot_types = ['j2735_msgs/RoadSegment[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RoadSegmentList, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.road_segment_list is None:
  ...
  def serialize(self, buff):
    ...
    """
    try:
      length = len(self.road_segment_list)
      buff.write(_struct_I.pack(length))
      for val1 in self.road_segment_list:
        _x = val1.name
        length = len(_x)
        ...
        buff.write(_get_struct_B().pack(_x))
        _v5 = val1.road_lane_set
        length = len(_v5.road_lane_set_list)
        buff.write(_struct_I.pack(length))
        for val3 in _v5.road_lane_set_list:
          _x = val3.lane_id
          buff.write(_get_struct_B().pack(_x))
          _x = val3.name
          length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        _v44.region_exists = bool(_v44.region_exists)
        _v44.id_exists = bool(_v44.id_exists)
        start = end
        end += 1
        ...
        for i in range(0, length):
          ...
          _v49 = val3.lane_attributes
          _v50 = _v49.directional_use
          start = end
          end += 1
          (_v50.lane_direction,) = _get_struct_B().unpack(str[start:end])
          _v51 = _v49.shared_with
          start = end
          end += 2
          (_v51.lane_sharing,) = _get_struct_H().unpack(str[start:end])
          _v52 = _v49.laneType
          start = end
          end += 1
          ...
          (_v53.lane_attributes_vehicle,) = _get_struct_B().unpack(str[start:end])
          _v54 = _v52.crosswalk
          start = end
          end += 2
          (_v54.lane_attributes_crosswalk,) = _get_struct_H().unpack(str[start:end])
          _v55 = _v52.bikeLane
          start = end
          end += 2
          (_v55.lane_attributes_bike,) = _get_struct_H().unpack(str[start:end])
          _v56 = _v52.sidewalk
          start = end
          end += 2
          (_v56.lane_attributes_sidewalk,) = _get_struct_H().unpack(str[start:end])
          _v57 = _v52.median
          start = end
          end += 2
          (_v57.lane_attributes_barrier,) = _get_struct_H().unpack(str[start:end])
          _v58 = _v52.striping
          start = end
          end += 2
          (_v58.lane_attributes_striping,) = _get_struct_H().unpack(str[start:end])
          _v59 = _v52.trackedVehicle
          start = end
          end += 2
          (_v59.lane_attributes_trackedvehicle,) = _get_struct_H().unpack(str[start:end])
          _v60 = _v52.parking
          start = end
          end += 2
          (_v60.lane_attributes_parking,) = _get_struct_H().unpack(str[start:end])
          _v61 = val3.maneuvers
          start = end
          end += 2
          (_v61.allowed_maneuvers,) = _get_struct_H().unpack(str[start:end])
          start = end
          end += 1
          ...
          (_v62.choice,) = _get_struct_B().unpack(str[start:end])
          _v63 = _v62.nodes
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          ...
          for i in range(0, length):
            ...
            (_v64.choice,) = _get_struct_B().unpack(str[start:end])
            _v65 = _v64.node_xy1
            _x = _v65
            start = end
            end += 8
            ...
            (_x.x, _x.y,) = _get_struct_2f().unpack(str[start:end])
            _v71 = _v64.node_latlon
            _x = _v71
            start = end
            end += 8
            (_x.longitude, _x.latitude,) = _get_struct_2i().unpack(str[start:end])
            _v72 = val6.attributes
            _v73 = _v72.local_node
            start = end
            end += 4
            (length,) = _struct_I.unpack(str[start:end])
            _v73.node_attribute_xy_List = []
            for i in range(0, length):
              val9 = j2735_msgs.msg.NodeAttributeXY()
              start = end
              end += 1
              (val9.node_attribute_xy,) = _get_struct_B().unpack(str[start:end])
              _v73.node_attribute_xy_List.append(val9)
            start = end
            end += 1
            (_v72.local_node_exists,) = _get_struct_B().unpack(str[start:end])
            _v72.local_node_exists = bool(_v72.local_node_exists)
            _v74 = _v72.disabled
            start = end
            end += 4
            (length,) = _struct_I.unpack(str[start:end])
            _v74.segment_attribute_xy = []
            for i in range(0, length):
              val9 = j2735_msgs.msg.SegmentAttributeXY()
              start = end
              end += 1
              (val9.segment_attribute_xy,) = _get_struct_B().unpack(str[start:end])
              _v74.segment_attribute_xy.append(val9)
            start = end
            end += 1
            (_v72.disabled_exists,) = _get_struct_B().unpack(str[start:end])
            _v72.disabled_exists = bool(_v72.disabled_exists)
            _v75 = _v72.enabled
            start = end
            end += 4
            (length,) = _struct_I.unpack(str[start:end])
            _v75.segment_attribute_xy = []
            for i in range(0, length):
              val9 = j2735_msgs.msg.SegmentAttributeXY()
              start = end
              end += 1
              (val9.segment_attribute_xy,) = _get_struct_B().unpack(str[start:end])
              _v75.segment_attribute_xy.append(val9)
            start = end
            end += 1
            (_v72.enabled_exists,) = _get_struct_B().unpack(str[start:end])
            _v72.enabled_exists = bool(_v72.enabled_exists)
            _v76 = _v72.data
            start = end
            end += 4
            (length,) = _struct_I.unpack(str[start:end])
            _v76.lane_attribute_list = []
            for i in range(0, length):
              ...
              for i in range(0, length):
                ...
                (_v78.speed_limit_type,) = _get_struct_B().unpack(str[start:end])
                start = end
                end += 8
                (val11.speed,) = _get_struct_d().unpack(str[start:end])
                _v77.speed_limits.append(val11)
              _v76.lane_attribute_list.append(val9)
            _x = _v72
            start = end
            end += 11
            (_x.data_exists, _x.dWitdh, _x.dWitdh_exists, _x.dElevation, _x.dElevation_exists,) = _get_struct_BfBfB().unpack(str[start:end])
            _v72.data_exists = bool(_v72.data_exists)
            _v72.dWitdh_exists = bool(_v72.dWitdh_exists)
            _v72.dElevation_exists = bool(_v72.dElevation_exists)
            start = end
            end += 1
            (val6.attributes_exists,) = _get_struct_B().unpack(str[start:end])
            val6.attributes_exists = bool(val6.attributes_exists)
            _v63.node_set_xy.append(val6)
          _v79 = _v62.computed
          start = end
          end += 2
          (_v79.reference_lane_id,) = _get_struct_H().unpack(str[start:end])
          _v80 = _v79.offset_x_axis
          _x = _v80
          start = end
          end += 5
          (_x.choice, _x.small, _x.large,) = _get_struct_B2h().unpack(str[start:end])
          _v81 = _v79.offset_y_axis
          _x = _v81
          start = end
          end += 5
          (_x.choice, _x.small, _x.large,) = _get_struct_B2h().unpack(str[start:end])
          ...
          _v79.rotatexy_exists = bool(_v79.rotatexy_exists)
          _v79.scale_x_axis_exists = bool(_v79.scale_x_axis_exists)
          _v79.scale_y_axis_exists = bool(_v79.scale_y_axis_exists)
          _v82 = val3.connects_to
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          _v82.connect_to_list = []
          for i in range(0, length):
            val5 = j2735_msgs.msg.Connection()
            _v83 = val5.connecting_lane
            start = end
            end += 2
            (_v83.lane,) = _get_struct_H().unpack(str[start:end])
            _v84 = _v83.maneuver
            start = end
            end += 2
            (_v84.allowed_maneuvers,) = _get_struct_H().unpack(str[start:end])
            start = end
            end += 1
            (_v83.maneuver_exists,) = _get_struct_B().unpack(str[start:end])
            _v83.maneuver_exists = bool(_v83.maneuver_exists)
            _v85 = val5.remote_intersection
            _x = _v85
            start = end
            end += 5
            (_x.region, _x.region_exists, _x.id,) = _get_struct_HBH().unpack(str[start:end])
            _v85.region_exists = bool(_v85.region_exists)
            _x = val5
            start = end
            end += 7
          ...
          _v86.overlay_lane_list = s.unpack(str[start:end])
          start = end
          end += 1
          ...
          _v48.road_lane_set_list.append(val3)
        self.road_segment_list.append(val1)
      return self
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      for val1 in self.road_segment_list:
        ...
        _x = val1
        buff.write(_get_struct_HB().pack(_x.lane_width, _x.lane_width_exists))
        _v89 = val1.speed_limits
        length = len(_v89.speed_limits)
        buff.write(_struct_I.pack(length))
        for val3 in _v89.speed_limits:
          _v90 = val3.type
          _x = _v90.speed_limit_type
          buff.write(_get_struct_B().pack(_x))
          _x = val3.speed
          buff.write(_get_struct_d().pack(_x))
        _x = val1.speed_limits_exists
        buff.write(_get_struct_B().pack(_x))
        _v91 = val1.road_lane_set
        length = len(_v91.road_lane_set_list)
        buff.write(_struct_I.pack(length))
        for val3 in _v91.road_lane_set_list:
          _x = val3.lane_id
          buff.write(_get_struct_B().pack(_x))
          _x = val3.name
          length = len(_x)
          ...
          _x = val3
          buff.write(_get_struct_5B().pack(_x.name_exists, _x.ingress_approach, _x.ingress_approach_exists, _x.egress_approach, _x.egress_approach_exists))
          _v92 = val3.lane_attributes
          _v93 = _v92.directional_use
          _x = _v93.lane_direction
          buff.write(_get_struct_B().pack(_x))
          _v94 = _v92.shared_with
          _x = _v94.lane_sharing
          buff.write(_get_struct_H().pack(_x))
          _v95 = _v92.laneType
          _x = _v95.choice
          buff.write(_get_struct_B().pack(_x))
          _v96 = _v95.vehicle
          _x = _v96.lane_attributes_vehicle
          buff.write(_get_struct_B().pack(_x))
          _v97 = _v95.crosswalk
          _x = _v97.lane_attributes_crosswalk
          buff.write(_get_struct_H().pack(_x))
          _v98 = _v95.bikeLane
          _x = _v98.lane_attributes_bike
          buff.write(_get_struct_H().pack(_x))
          _v99 = _v95.sidewalk
          _x = _v99.lane_attributes_sidewalk
          buff.write(_get_struct_H().pack(_x))
          _v100 = _v95.median
          _x = _v100.lane_attributes_barrier
          buff.write(_get_struct_H().pack(_x))
          _v101 = _v95.striping
          _x = _v101.lane_attributes_striping
          buff.write(_get_struct_H().pack(_x))
          _v102 = _v95.trackedVehicle
          _x = _v102.lane_attributes_trackedvehicle
          buff.write(_get_struct_H().pack(_x))
          _v103 = _v95.parking
          _x = _v103.lane_attributes_parking
          buff.write(_get_struct_H().pack(_x))
          _v104 = val3.maneuvers
          _x = _v104.allowed_maneuvers
          buff.write(_get_struct_H().pack(_x))
          _x = val3.maneuvers_exists
          buff.write(_get_struct_B().pack(_x))
          _v105 = val3.node_list
          _x = _v105.choice
          buff.write(_get_struct_B().pack(_x))
          _v106 = _v105.nodes
          length = len(_v106.node_set_xy)
          buff.write(_struct_I.pack(length))
          for val6 in _v106.node_set_xy:
            _v107 = val6.delta
            _x = _v107.choice
            buff.write(_get_struct_B().pack(_x))
            _v108 = _v107.node_xy1
            _x = _v108
            buff.write(_get_struct_2f().pack(_x.x, _x.y))
            _v109 = _v107.node_xy2
            _x = _v109
            buff.write(_get_struct_2f().pack(_x.x, _x.y))
            _v110 = _v107.node_xy3
            _x = _v110
            buff.write(_get_struct_2f().pack(_x.x, _x.y))
            _v111 = _v107.node_xy4
            _x = _v111
            buff.write(_get_struct_2f().pack(_x.x, _x.y))
            _v112 = _v107.node_xy5
            _x = _v112
            buff.write(_get_struct_2f().pack(_x.x, _x.y))
            _v113 = _v107.node_xy6
            _x = _v113
            buff.write(_get_struct_2f().pack(_x.x, _x.y))
            _v114 = _v107.node_latlon
            _x = _v114
            buff.write(_get_struct_2i().pack(_x.longitude, _x.latitude))
            _v115 = val6.attributes
            _v116 = _v115.local_node
            length = len(_v116.node_attribute_xy_List)
            buff.write(_struct_I.pack(length))
            for val9 in _v116.node_attribute_xy_List:
              _x = val9.node_attribute_xy
              buff.write(_get_struct_B().pack(_x))
            _x = _v115.local_node_exists
            buff.write(_get_struct_B().pack(_x))
            _v117 = _v115.disabled
            length = len(_v117.segment_attribute_xy)
            buff.write(_struct_I.pack(length))
            for val9 in _v117.segment_attribute_xy:
              _x = val9.segment_attribute_xy
              buff.write(_get_struct_B().pack(_x))
            _x = _v115.disabled_exists
            buff.write(_get_struct_B().pack(_x))
            _v118 = _v115.enabled
            length = len(_v118.segment_attribute_xy)
            buff.write(_struct_I.pack(length))
            for val9 in _v118.segment_attribute_xy:
              _x = val9.segment_attribute_xy
              buff.write(_get_struct_B().pack(_x))
            _x = _v115.enabled_exists
            buff.write(_get_struct_B().pack(_x))
            _v119 = _v115.data
            length = len(_v119.lane_attribute_list)
            buff.write(_struct_I.pack(length))
            for val9 in _v119.lane_attribute_list:
              _x = val9
              buff.write(_get_struct_Bh3bh().pack(_x.choice, _x.path_end_point_angle, _x.lane_crown_point_center, _x.lane_crown_point_right, _x.lane_crown_point_left, _x.lane_angle))
              _v120 = val9.speed_limits
              length = len(_v120.speed_limits)
              buff.write(_struct_I.pack(length))
              for val11 in _v120.speed_limits:
                _v121 = val11.type
                _x = _v121.speed_limit_type
                buff.write(_get_struct_B().pack(_x))
                _x = val11.speed
                buff.write(_get_struct_d().pack(_x))
            _x = _v115
            ...
            _x = val6.attributes_exists
            buff.write(_get_struct_B().pack(_x))
          _v122 = _v105.computed
          _x = _v122.reference_lane_id
          buff.write(_get_struct_H().pack(_x))
          _v123 = _v122.offset_x_axis
          _x = _v123
          buff.write(_get_struct_B2h().pack(_x.choice, _x.small, _x.large))
          _v124 = _v122.offset_y_axis
          _x = _v124
          buff.write(_get_struct_B2h().pack(_x.choice, _x.small, _x.large))
          _x = _v122
          buff.write(_get_struct_HBhBhB().pack(_x.rotateXY, _x.rotatexy_exists, _x.scale_x_axis, _x.scale_x_axis_exists, _x.scale_y_axis, _x.scale_y_axis_exists))
          _v125 = val3.connects_to
          length = len(_v125.connect_to_list)
          buff.write(_struct_I.pack(length))
          for val5 in _v125.connect_to_list:
            _v126 = val5.connecting_lane
            _x = _v126.lane
            buff.write(_get_struct_H().pack(_x))
            _v127 = _v126.maneuver
            _x = _v127.allowed_maneuvers
            buff.write(_get_struct_H().pack(_x))
            _x = _v126.maneuver_exists
            buff.write(_get_struct_B().pack(_x))
            _v128 = val5.remote_intersection
            _x = _v128
            buff.write(_get_struct_HBH().pack(_x.region, _x.region_exists, _x.id))
            _x = val5
            buff.write(_get_struct_7B().pack(_x.remote_intersection_exists, _x.signal_group, _x.signal_group_exists, _x.user_class, _x.user_class_exists, _x.connection_id, _x.connection_id_exists))
          _x = val3.connects_to_exists
          buff.write(_get_struct_B().pack(_x))
          _v129 = val3.overlay_lane_list
          length = len(_v129.overlay_lane_list)
          buff.write(_struct_I.pack(length))
          pattern = '<%sH'%length
          buff.write(_v129.overlay_lane_list.tostring())
          _x = val3.overlay_lane_list_exists
          buff.write(_get_struct_B().pack(_x))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_x.region, _x.region_exists, _x.id, _x.id_exists,) = _get_struct_HBHB().unpack(str[start:end])
        _v130.region_exists = bool(_v130.region_exists)
        _v130.id_exists = bool(_v130.id_exists)
        start = end
        end += 1
        (val1.revision,) = _get_struct_B().unpack(str[start:end])
        _v131 = val1.ref_point
        _x = _v131
        start = end
        end += 21
        (_x.latitude, _x.longitude, _x.elevation, _x.elevation_exists,) = _get_struct_2dfB().unpack(str[start:end])
        _v131.elevation_exists = bool(_v131.elevation_exists)
        _x = val1
        start = end
        end += 3
        (_x.lane_width, _x.lane_width_exists,) = _get_struct_HB().unpack(str[start:end])
        val1.lane_width_exists = bool(val1.lane_width_exists)
        _v132 = val1.speed_limits
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v132.speed_limits = []
        for i in range(0, length):
          ...
          (_v133.speed_limit_type,) = _get_struct_B().unpack(str[start:end])
          start = end
          end += 8
          (val3.speed,) = _get_struct_d().unpack(str[start:end])
          _v132.speed_limits.append(val3)
        start = end
        end += 1
        (val1.speed_limits_exists,) = _get_struct_B().unpack(str[start:end])
        val1.speed_limits_exists = bool(val1.speed_limits_exists)
        _v134 = val1.road_lane_set
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v134.road_lane_set_list = []
        for i in range(0, length):
          val3 = j2735_msgs.msg.GenericLane()
          start = end
          end += 1
          ...
          val3.ingress_approach_exists = bool(val3.ingress_approach_exists)
          val3.egress_approach_exists = bool(val3.egress_approach_exists)
          _v135 = val3.lane_attributes
          _v136 = _v135.directional_use
          start = end
          end += 1
          (_v136.lane_direction,) = _get_struct_B().unpack(str[start:end])
          _v137 = _v135.shared_with
          start = end
          end += 2
          (_v137.lane_sharing,) = _get_struct_H().unpack(str[start:end])
          _v138 = _v135.laneType
          start = end
          end += 1
          (_v138.choice,) = _get_struct_B().unpack(str[start:end])
          _v139 = _v138.vehicle
          start = end
          end += 1
          (_v139.lane_attributes_vehicle,) = _get_struct_B().unpack(str[start:end])
          _v140 = _v138.crosswalk
          start = end
          end += 2
          (_v140.lane_attributes_crosswalk,) = _get_struct_H().unpack(str[start:end])
          _v141 = _v138.bikeLane
          start = end
          end += 2
          (_v141.lane_attributes_bike,) = _get_struct_H().unpack(str[start:end])
          _v142 = _v138.sidewalk
          start = end
          end += 2
          (_v142.lane_attributes_sidewalk,) = _get_struct_H().unpack(str[start:end])
          _v143 = _v138.median
          start = end
          end += 2
          (_v143.lane_attributes_barrier,) = _get_struct_H().unpack(str[start:end])
          _v144 = _v138.striping
          start = end
          end += 2
          (_v144.lane_attributes_striping,) = _get_struct_H().unpack(str[start:end])
          _v145 = _v138.trackedVehicle
          start = end
          end += 2
          (_v145.lane_attributes_trackedvehicle,) = _get_struct_H().unpack(str[start:end])
          _v146 = _v138.parking
          start = end
          end += 2
          (_v146.lane_attributes_parking,) = _get_struct_H().unpack(str[start:end])
          _v147 = val3.maneuvers
          start = end
          end += 2
          (_v147.allowed_maneuvers,) = _get_struct_H().unpack(str[start:end])
          start = end
          end += 1
          (val3.maneuvers_exists,) = _get_struct_B().unpack(str[start:end])
          val3.maneuvers_exists = bool(val3.maneuvers_exists)
          _v148 = val3.node_list
          start = end
          end += 1
          (_v148.choice,) = _get_struct_B().unpack(str[start:end])
          _v149 = _v148.nodes
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          ...
          for i in range(0, length):
            ...
            _v151 = _v150.node_xy1
            _x = _v151
            start = end
            end += 8
            (_x.x, _x.y,) = _get_struct_2f().unpack(str[start:end])
            _v152 = _v150.node_xy2
            _x = _v152
            start = end
            end += 8
            (_x.x, _x.y,) = _get_struct_2f().unpack(str[start:end])
            _v153 = _v150.node_xy3
            _x = _v153
            start = end
            end += 8
            (_x.x, _x.y,) = _get_struct_2f().unpack(str[start:end])
            _v154 = _v150.node_xy4
            _x = _v154
            start = end
            end += 8
            (_x.x, _x.y,) = _get_struct_2f().unpack(str[start:end])
            _v155 = _v150.node_xy5
            _x = _v155
            start = end
            end += 8
            (_x.x, _x.y,) = _get_struct_2f().unpack(str[start:end])
            _v156 = _v150.node_xy6
            _x = _v156
            start = end
            end += 8
            (_x.x, _x.y,) = _get_struct_2f().unpack(str[start:end])
            _v157 = _v150.node_latlon
            _x = _v157
            start = end
            end += 8
            (_x.longitude, _x.latitude,) = _get_struct_2i().unpack(str[start:end])
            _v158 = val6.attributes
            _v159 = _v158.local_node
            start = end
            end += 4
            (length,) = _struct_I.unpack(str[start:end])
            _v159.node_attribute_xy_List = []
            for i in range(0, length):
              val9 = j2735_msgs.msg.NodeAttributeXY()
              start = end
              end += 1
              (val9.node_attribute_xy,) = _get_struct_B().unpack(str[start:end])
              _v159.node_attribute_xy_List.append(val9)
            start = end
            end += 1
            (_v158.local_node_exists,) = _get_struct_B().unpack(str[start:end])
            _v158.local_node_exists = bool(_v158.local_node_exists)
            _v160 = _v158.disabled
            start = end
            end += 4
            (length,) = _struct_I.unpack(str[start:end])
            _v160.segment_attribute_xy = []
            for i in range(0, length):
              val9 = j2735_msgs.msg.SegmentAttributeXY()
              start = end
              end += 1
              (val9.segment_attribute_xy,) = _get_struct_B().unpack(str[start:end])
              _v160.segment_attribute_xy.append(val9)
            start = end
            end += 1
            (_v158.disabled_exists,) = _get_struct_B().unpack(str[start:end])
            _v158.disabled_exists = bool(_v158.disabled_exists)
            _v161 = _v158.enabled
            start = end
            end += 4
            (length,) = _struct_I.unpack(str[start:end])
            _v161.segment_attribute_xy = []
            for i in range(0, length):
              val9 = j2735_msgs.msg.SegmentAttributeXY()
              start = end
              end += 1
              (val9.segment_attribute_xy,) = _get_struct_B().unpack(str[start:end])
              _v161.segment_attribute_xy.append(val9)
            start = end
            end += 1
            (_v158.enabled_exists,) = _get_struct_B().unpack(str[start:end])
            _v158.enabled_exists = bool(_v158.enabled_exists)
            _v162 = _v158.data
            start = end
            end += 4
            (length,) = _struct_I.unpack(str[start:end])
            _v162.lane_attribute_list = []
            for i in range(0, length):
              val9 = j2735_msgs.msg.LaneDataAttribute()
              _x = val9
              start = end
              ...
              for i in range(0, length):
                ...
                (_v164.speed_limit_type,) = _get_struct_B().unpack(str[start:end])
                start = end
                end += 8
                (val11.speed,) = _get_struct_d().unpack(str[start:end])
                _v163.speed_limits.append(val11)
              _v162.lane_attribute_list.append(val9)
            _x = _v158
            start = end
            end += 11
            (_x.data_exists, _x.dWitdh, _x.dWitdh_exists, _x.dElevation, _x.dElevation_exists,) = _get_struct_BfBfB().unpack(str[start:end])
            _v158.data_exists = bool(_v158.data_exists)
            _v158.dWitdh_exists = bool(_v158.dWitdh_exists)
            _v158.dElevation_exists = bool(_v158.dElevation_exists)
            start = end
            end += 1
            (val6.attributes_exists,) = _get_struct_B().unpack(str[start:end])
            val6.attributes_exists = bool(val6.attributes_exists)
            _v149.node_set_xy.append(val6)
          _v165 = _v148.computed
          start = end
          end += 2
          (_v165.reference_lane_id,) = _get_struct_H().unpack(str[start:end])
          _v166 = _v165.offset_x_axis
          _x = _v166
          start = end
          end += 5
          (_x.choice, _x.small, _x.large,) = _get_struct_B2h().unpack(str[start:end])
          _v167 = _v165.offset_y_axis
          _x = _v167
          start = end
          end += 5
          (_x.choice, _x.small, _x.large,) = _get_struct_B2h().unpack(str[start:end])
          ...
          (_x.rotateXY, _x.rotatexy_exists, _x.scale_x_axis, _x.scale_x_axis_exists, _x.scale_y_axis, _x.scale_y_axis_exists,) = _get_struct_HBhBhB().unpack(str[start:end])
          _v165.rotatexy_exists = bool(_v165.rotatexy_exists)
          _v165.scale_x_axis_exists = bool(_v165.scale_x_axis_exists)
          _v165.scale_y_axis_exists = bool(_v165.scale_y_axis_exists)
          _v168 = val3.connects_to
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          _v168.connect_to_list = []
          for i in range(0, length):
            val5 = j2735_msgs.msg.Connection()
            _v169 = val5.connecting_lane
            start = end
            end += 2
            (_v169.lane,) = _get_struct_H().unpack(str[start:end])
            _v170 = _v169.maneuver
            start = end
            end += 2
            (_v170.allowed_maneuvers,) = _get_struct_H().unpack(str[start:end])
            start = end
            end += 1
            (_v169.maneuver_exists,) = _get_struct_B().unpack(str[start:end])
            _v169.maneuver_exists = bool(_v169.maneuver_exists)
            _v171 = val5.remote_intersection
            _x = _v171
            start = end
            end += 5
            (_x.region, _x.region_exists, _x.id,) = _get_struct_HBH().unpack(str[start:end])
            _v171.region_exists = bool(_v171.region_exists)
            _x = val5
            start = end
            end += 7
            (_x.remote_intersection_exists, _x.signal_group, _x.signal_group_exists, _x.user_class, _x.user_class_exists, _x.connection_id, _x.connection_id_exists,) = _get_struct_7B().unpack(str[start:end])
            ...
            val5.user_class_exists = bool(val5.user_class_exists)
            val5.connection_id_exists = bool(val5.connection_id_exists)
            _v168.connect_to_list.append(val5)
          start = end
          end += 1
          (val3.connects_to_exists,) = _get_struct_B().unpack(str[start:end])
          val3.connects_to_exists = bool(val3.connects_to_exists)
          _v172 = val3.overlay_lane_list
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          pattern = '<%sH'%length
          ...
          _v172.overlay_lane_list = numpy.frombuffer(str[start:end], dtype=numpy.uint16, count=length)
          start = end
          end += 1
          (val3.overlay_lane_list_exists,) = _get_struct_B().unpack(str[start:end])
          val3.overlay_lane_list_exists = bool(val3.overlay_lane_list_exists)
          _v134.road_lane_set_list.append(val3)
        self.road_segment_list.append(val1)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
