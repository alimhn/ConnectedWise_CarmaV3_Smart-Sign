...
"""autogenerated by genpy from j2735_msgs/ByteArray.msg. Do not edit."""
import codecs
import sys
...
class ByteArray(genpy.Message):
  _md5sum = "6b87f87806cca414ef2cd41baf1a8ce0"
  _type = "j2735_msgs/ByteArray"
...
string frame_id
"""
  __slots__ = ['header','messageType','content']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.messageType = str[start:end].decode('utf-8', 'rosmsg')
      else:
