...
"""autogenerated by genpy from j2735_msgs/LaneDirection.msg. Do not edit."""
import codecs
import sys
...
class LaneDirection(genpy.Message):
  _md5sum = "e54bbf0b78a512c3a5e1e30ccec9630b"
  _type = "j2735_msgs/LaneDirection"
...
uint8 lane_direction"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LaneDirection, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.lane_direction is None:
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.lane_direction,) = _get_struct_B().unpack(str[start:end])
      return self
