...
"""autogenerated by genpy from j2735_msgs/RestrictionClassList.msg. Do not edit."""
import codecs
import sys
...
class RestrictionClassList(genpy.Message):
  _md5sum = "39c5820cd159fd97238dd797c4d5b5d8"
  _type = "j2735_msgs/RestrictionClassList"
...
"""
  __slots__ = ['restriction_class_list']
  _slot_types = ['j2735_msgs/RestrictionClassAssignment[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RestrictionClassList, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.restriction_class_list is None:
        self.restriction_class_list = []
    else:
      self.restriction_class_list = []
  ...
  def serialize(self, buff):
    ...
    """
    try:
      length = len(self.restriction_class_list)
      buff.write(_struct_I.pack(length))
      for val1 in self.restriction_class_list:
        _x = val1.id
  ...
  def deserialize(self, str):
    ...
    try:
      if self.restriction_class_list is None:
        self.restriction_class_list = None
      end = 0
      start = end
      end += 4
      ...
      for i in range(0, length):
        ...
        self.restriction_class_list.append(val1)
      return self
