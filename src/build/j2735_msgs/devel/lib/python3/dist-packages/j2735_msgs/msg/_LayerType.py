...
"""autogenerated by genpy from j2735_msgs/LayerType.msg. Do not edit."""
import codecs
import sys
...
class LayerType(genpy.Message):
  _md5sum = "225f090984ed5db591d792a4385a39de"
  _type = "j2735_msgs/LayerType"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# LayerType.msg
#
...
uint8       SHARED_LANE_DATA = 7"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LayerType, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.layer_type,) = _get_struct_B().unpack(str[start:end])
      return self
