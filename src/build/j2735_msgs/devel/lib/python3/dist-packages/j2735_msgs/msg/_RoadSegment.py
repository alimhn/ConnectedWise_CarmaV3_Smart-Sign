...
"""autogenerated by genpy from j2735_msgs/RoadSegment.msg. Do not edit."""
import codecs
import sys
...
class RoadSegment(genpy.Message):
  _md5sum = "9299db39f63085d859ce33cb3ccd2ca7"
  _type = "j2735_msgs/RoadSegment"
...
uint16[] overlay_lane_list"""
  __slots__ = ['name','name_exists','id','revision','ref_point','lane_width','lane_width_exists','speed_limits','speed_limits_exists','road_lane_set']
  _slot_types = ['string','bool','j2735_msgs/RoadSegmentReferenceID','uint8','j2735_msgs/Position3D','uint16','bool','j2735_msgs/SpeedLimitList','bool','j2735_msgs/RoadLaneSetList']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       name,name_exists,id,revision,ref_point,lane_width,lane_width_exists,speed_limits,speed_limits_exists,road_lane_set
    ...
    if args or kwds:
      ...
      if self.id is None:
        self.id = j2735_msgs.msg.RoadSegmentReferenceID()
      ...
      if self.road_lane_set is None:
        self.road_lane_set = j2735_msgs.msg.RoadLaneSetList()
    else:
      self.name = ''
      self.name_exists = False
      self.id = j2735_msgs.msg.RoadSegmentReferenceID()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_BHBH2B2dfBHB().pack(_x.name_exists, _x.id.region, _x.id.region_exists, _x.id.id, _x.id.id_exists, _x.revision, _x.ref_point.latitude, _x.ref_point.longitude, _x.ref_point.elevation, _x.ref_point.elevation_exists, _x.lane_width, _x.lane_width_exists))
      ...
      buff.write(_get_struct_B().pack(_x))
      length = len(self.road_lane_set.road_lane_set_list)
      buff.write(_struct_I.pack(length))
      for val1 in self.road_lane_set.road_lane_set_list:
        _x = val1.lane_id
        buff.write(_get_struct_B().pack(_x))
        _x = val1.name
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.name_exists, _x.id.region, _x.id.region_exists, _x.id.id, _x.id.id_exists, _x.revision, _x.ref_point.latitude, _x.ref_point.longitude, _x.ref_point.elevation, _x.ref_point.elevation_exists, _x.lane_width, _x.lane_width_exists,) = _get_struct_BHBH2B2dfBHB().unpack(str[start:end])
      self.name_exists = bool(self.name_exists)
      self.id.region_exists = bool(self.id.region_exists)
      self.id.id_exists = bool(self.id.id_exists)
      ...
      (length,) = _struct_I.unpack(str[start:end])
      self.road_lane_set.road_lane_set_list = []
      for i in range(0, length):
        ...
        self.road_lane_set.road_lane_set_list.append(val1)
      return self
...
def _get_struct_B2h():
    ...
    return _struct_B2h
_struct_BHBH2B2dfBHB = None
def _get_struct_BHBH2B2dfBHB():
    global _struct_BHBH2B2dfBHB
    if _struct_BHBH2B2dfBHB is None:
        _struct_BHBH2B2dfBHB = struct.Struct("<BHBH2B2dfBHB")
    return _struct_BHBH2B2dfBHB
_struct_BfBfB = None
