...
"""autogenerated by genpy from j2735_msgs/NodeSetXY.msg. Do not edit."""
import codecs
import sys
...
class NodeSetXY(genpy.Message):
  _md5sum = "d666523fe355e90a00861ac4c2085728"
  _type = "j2735_msgs/NodeSetXY"
...
uint8 VEHICLESWITHTRAILERSNIGHTMAXSPEED=12"""
  __slots__ = ['node_set_xy']
  _slot_types = ['j2735_msgs/NodeXY[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(NodeSetXY, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.node_set_xy is None:
        self.node_set_xy = []
    else:
      self.node_set_xy = []
  ...
  def serialize(self, buff):
    ...
    """
    try:
      length = len(self.node_set_xy)
      buff.write(_struct_I.pack(length))
      for val1 in self.node_set_xy:
        _v1 = val1.delta
        _x = _v1.choice
