...
"""autogenerated by genpy from j2735_msgs/MovementList.msg. Do not edit."""
import codecs
import sys
...
class MovementList(genpy.Message):
  _md5sum = "fc3fb3a1c80422de61bd621e777c7b4d"
  _type = "j2735_msgs/MovementList"
...
# regional #TODO: RegionalExtensions are not yet implemented in asn1c"""
  __slots__ = ['movement_list']
  _slot_types = ['j2735_msgs/MovementState[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MovementList, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.movement_list is None:
        self.movement_list = []
    else:
      self.movement_list = []
  ...
  def serialize(self, buff):
    ...
    """
    try:
      length = len(self.movement_list)
      buff.write(_struct_I.pack(length))
      for val1 in self.movement_list:
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.movement_list.append(val1)
      return self
