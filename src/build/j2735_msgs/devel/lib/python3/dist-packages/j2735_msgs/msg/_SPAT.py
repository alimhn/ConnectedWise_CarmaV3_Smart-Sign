...
"""autogenerated by genpy from j2735_msgs/SPAT.msg. Do not edit."""
import codecs
import sys
...
class SPAT(genpy.Message):
  _md5sum = "b4c40f2649b94d25d15c1e9f47c45af8"
  _type = "j2735_msgs/SPAT"
...
# regional #TODO: RegionalExtensions are not yet implemented in asn1c"""
  __slots__ = ['time_stamp','time_stamp_exists','name','name_exists','intersections']
  _slot_types = ['uint32','bool','string','bool','j2735_msgs/IntersectionStateList']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       time_stamp,time_stamp_exists,name,name_exists,intersections
    ...
    if args or kwds:
      ...
      if self.intersections is None:
        self.intersections = j2735_msgs.msg.IntersectionStateList()
    else:
      self.time_stamp = 0
      self.time_stamp_exists = False
      self.name = ''
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_IB().pack(_x.time_stamp, _x.time_stamp_exists))
      _x = self.name
      length = len(_x)
      ...
      length = len(self.intersections.intersection_state_list)
      buff.write(_struct_I.pack(length))
      for val1 in self.intersections.intersection_state_list:
        _x = val1.name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.time_stamp, _x.time_stamp_exists,) = _get_struct_IB().unpack(str[start:end])
      ...
      (self.name_exists,) = _get_struct_B().unpack(str[start:end])
      self.name_exists = bool(self.name_exists)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.intersections.intersection_state_list = []
      for i in range(0, length):
        ...
        self.intersections.intersection_state_list.append(val1)
      return self
