...
"""autogenerated by genpy from j2735_msgs/LaneDataAttribute.msg. Do not edit."""
import codecs
import sys
...
class LaneDataAttribute(genpy.Message):
  _md5sum = "60767373006c4dcaecb2eed2a25e812b"
  _type = "j2735_msgs/LaneDataAttribute"
...
uint8 VEHICLESWITHTRAILERSNIGHTMAXSPEED=12"""
  ...
  __slots__ = ['choice','path_end_point_angle','lane_crown_point_center','lane_crown_point_right','lane_crown_point_left','lane_angle','speed_limits']
  _slot_types = ['uint8','int16','int8','int8','int8','int16','j2735_msgs/SpeedLimitList']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       choice,path_end_point_angle,lane_crown_point_center,lane_crown_point_right,lane_crown_point_left,lane_angle,speed_limits
    ...
    """
    if args or kwds:
      super(LaneDataAttribute, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.choice is None:
        self.choice = 0
      if self.path_end_point_angle is None:
        self.path_end_point_angle = 0
      if self.lane_crown_point_center is None:
        self.lane_crown_point_center = 0
      if self.lane_crown_point_right is None:
        self.lane_crown_point_right = 0
      if self.lane_crown_point_left is None:
        self.lane_crown_point_left = 0
