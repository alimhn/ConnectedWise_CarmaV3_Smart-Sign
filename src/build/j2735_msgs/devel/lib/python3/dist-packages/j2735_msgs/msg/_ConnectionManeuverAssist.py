...
"""autogenerated by genpy from j2735_msgs/ConnectionManeuverAssist.msg. Do not edit."""
import codecs
import sys
...
class ConnectionManeuverAssist(genpy.Message):
  _md5sum = "0828917931a657d68a5c850fd3b65bc0"
  _type = "j2735_msgs/ConnectionManeuverAssist"
...
# regional #TODO: RegionalExtensions are not yet implemented in asn1c"""
  __slots__ = ['connection_id','queue_length','queue_length_exists','available_storage_length','available_storage_length_exists','wait_on_stop','wait_on_stop_exists','ped_bicycle_detect','ped_bicycle_detect_exists']
  _slot_types = ['uint8','uint16','bool','uint16','bool','bool','bool','bool','bool']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       connection_id,queue_length,queue_length_exists,available_storage_length,available_storage_length_exists,wait_on_stop,wait_on_stop_exists,ped_bicycle_detect,ped_bicycle_detect_exists
    ...
    """
    if args or kwds:
      super(ConnectionManeuverAssist, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.connection_id is None:
        self.connection_id = 0
      if self.queue_length is None:
        self.queue_length = 0
      if self.queue_length_exists is None:
        self.queue_length_exists = False
      if self.available_storage_length is None:
        self.available_storage_length = 0
      if self.available_storage_length_exists is None:
        self.available_storage_length_exists = False
      if self.wait_on_stop is None:
        self.wait_on_stop = False
      if self.wait_on_stop_exists is None:
        self.wait_on_stop_exists = False
      if self.ped_bicycle_detect is None:
        self.ped_bicycle_detect = False
      if self.ped_bicycle_detect_exists is None:
        self.ped_bicycle_detect_exists = False
    else:
      self.connection_id = 0
      self.queue_length = 0
      self.queue_length_exists = False
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.queue_length_exists = bool(self.queue_length_exists)
      self.available_storage_length_exists = bool(self.available_storage_length_exists)
      self.wait_on_stop = bool(self.wait_on_stop)
      self.wait_on_stop_exists = bool(self.wait_on_stop_exists)
      self.ped_bicycle_detect = bool(self.ped_bicycle_detect)
      self.ped_bicycle_detect_exists = bool(self.ped_bicycle_detect_exists)
      return self
