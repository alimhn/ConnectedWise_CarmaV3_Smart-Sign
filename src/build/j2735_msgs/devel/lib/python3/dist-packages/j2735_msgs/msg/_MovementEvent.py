...
"""autogenerated by genpy from j2735_msgs/MovementEvent.msg. Do not edit."""
import codecs
import sys
...
class MovementEvent(genpy.Message):
  _md5sum = "761599329944c7cfb6a4fdf84a54a500"
  _type = "j2735_msgs/MovementEvent"
...
uint8 PREC0_05MS=6
uint8 PREC0_01MS=7"""
  __slots__ = ['event_state','timing','timing_exists','speeds','speeds_exists']
  _slot_types = ['j2735_msgs/MovementPhaseState','j2735_msgs/TimeChangeDetails','bool','j2735_msgs/AdvisorySpeedList','bool']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       event_state,timing,timing_exists,speeds,speeds_exists
    ...
    """
    if args or kwds:
      super(MovementEvent, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.event_state is None:
        self.event_state = j2735_msgs.msg.MovementPhaseState()
      if self.timing is None:
        self.timing = j2735_msgs.msg.TimeChangeDetails()
      if self.timing_exists is None:
        self.timing_exists = False
      if self.speeds is None:
        self.speeds = j2735_msgs.msg.AdvisorySpeedList()
      if self.speeds_exists is None:
        self.speeds_exists = False
    else:
      self.event_state = j2735_msgs.msg.MovementPhaseState()
      self.timing = j2735_msgs.msg.TimeChangeDetails()
      self.timing_exists = False
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_BHB2HBH3BH2B().pack(_x.event_state.movement_phase_state, _x.timing.start_time, _x.timing.start_time_exists, _x.timing.min_end_time, _x.timing.max_end_time, _x.timing.max_end_time_exists, _x.timing.likely_time, _x.timing.likely_time_exists, _x.timing.confidence, _x.timing.confidence_exists, _x.timing.next_time, _x.timing.next_time_exists, _x.timing_exists))
      length = len(self.speeds.advisory_speed_list)
      buff.write(_struct_I.pack(length))
      for val1 in self.speeds.advisory_speed_list:
        _v1 = val1.type
        _x = _v1.advisory_speed_type
        buff.write(_get_struct_B().pack(_x))
        _x = val1
        buff.write(_get_struct_fB().pack(_x.speed, _x.speed_exists))
        _v2 = val1.confidence
        _x = _v2.speed_confidence
        buff.write(_get_struct_B().pack(_x))
        _x = val1
        buff.write(_get_struct_H3B().pack(_x.distance, _x.distance_exists, _x.restriction_class_id, _x.restriction_class_id_exists))
      _x = self.speeds_exists
      buff.write(_get_struct_B().pack(_x))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.event_state.movement_phase_state, _x.timing.start_time, _x.timing.start_time_exists, _x.timing.min_end_time, _x.timing.max_end_time, _x.timing.max_end_time_exists, _x.timing.likely_time, _x.timing.likely_time_exists, _x.timing.confidence, _x.timing.confidence_exists, _x.timing.next_time, _x.timing.next_time_exists, _x.timing_exists,) = _get_struct_BHB2HBH3BH2B().unpack(str[start:end])
      self.timing.start_time_exists = bool(self.timing.start_time_exists)
      self.timing.max_end_time_exists = bool(self.timing.max_end_time_exists)
      self.timing.likely_time_exists = bool(self.timing.likely_time_exists)
      self.timing.confidence_exists = bool(self.timing.confidence_exists)
      self.timing.next_time_exists = bool(self.timing.next_time_exists)
      self.timing_exists = bool(self.timing_exists)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.speeds.advisory_speed_list = []
      for i in range(0, length):
        val1 = j2735_msgs.msg.AdvisorySpeed()
        _v3 = val1.type
        start = end
        end += 1
        (_v3.advisory_speed_type,) = _get_struct_B().unpack(str[start:end])
        _x = val1
        start = end
        end += 5
        (_x.speed, _x.speed_exists,) = _get_struct_fB().unpack(str[start:end])
        val1.speed_exists = bool(val1.speed_exists)
        _v4 = val1.confidence
        start = end
        end += 1
        (_v4.speed_confidence,) = _get_struct_B().unpack(str[start:end])
        _x = val1
        start = end
        end += 5
        ...
        val1.distance_exists = bool(val1.distance_exists)
        val1.restriction_class_id_exists = bool(val1.restriction_class_id_exists)
        self.speeds.advisory_speed_list.append(val1)
      start = end
      end += 1
      (self.speeds_exists,) = _get_struct_B().unpack(str[start:end])
      self.speeds_exists = bool(self.speeds_exists)
      return self
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_v7.advisory_speed_type,) = _get_struct_B().unpack(str[start:end])
        _x = val1
        start = end
        end += 5
        (_x.speed, _x.speed_exists,) = _get_struct_fB().unpack(str[start:end])
        ...
        (_v8.speed_confidence,) = _get_struct_B().unpack(str[start:end])
        _x = val1
        start = end
        end += 5
        (_x.distance, _x.distance_exists, _x.restriction_class_id, _x.restriction_class_id_exists,) = _get_struct_H3B().unpack(str[start:end])
