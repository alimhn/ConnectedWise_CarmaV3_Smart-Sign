// Generated by gencpp from file j2735_msgs/MovementEvent.msg
// DO NOT EDIT!


#ifndef J2735_MSGS_MESSAGE_MOVEMENTEVENT_H
#define J2735_MSGS_MESSAGE_MOVEMENTEVENT_H
...
#include <j2735_msgs/MovementPhaseState.h>
#include <j2735_msgs/TimeChangeDetails.h>
#include <j2735_msgs/AdvisorySpeedList.h>
...
{
  typedef MovementEvent_<ContainerAllocator> Type;
  ...
  MovementEvent_(const ContainerAllocator& _alloc)
    : event_state(_alloc)
    , timing(_alloc)
    , timing_exists(false)
    , speeds(_alloc)
  ...
  (void)_alloc;
   ...
   typedef  ::j2735_msgs::MovementPhaseState_<ContainerAllocator>  _event_state_type;
  _event_state_type event_state;

   typedef  ::j2735_msgs::TimeChangeDetails_<ContainerAllocator>  _timing_type;
  _timing_type timing;

   typedef uint8_t _timing_exists_type;
  _timing_exists_type timing_exists;

   typedef  ::j2735_msgs::AdvisorySpeedList_<ContainerAllocator>  _speeds_type;
  _speeds_type speeds;

   typedef uint8_t _speeds_exists_type;
  ...
  typedef boost::shared_ptr< ::j2735_msgs::MovementEvent_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::j2735_msgs::MovementEvent_<ContainerAllocator> const> ConstPtr;

}; // struct MovementEvent_

typedef ::j2735_msgs::MovementEvent_<std::allocator<void> > MovementEvent;

typedef boost::shared_ptr< ::j2735_msgs::MovementEvent > MovementEventPtr;
typedef boost::shared_ptr< ::j2735_msgs::MovementEvent const> MovementEventConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::j2735_msgs::MovementEvent_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::j2735_msgs::MovementEvent_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::j2735_msgs::MovementEvent_<ContainerAllocator1> & lhs, const ::j2735_msgs::MovementEvent_<ContainerAllocator2> & rhs)
{
  return lhs.event_state == rhs.event_state &&
    lhs.timing == rhs.timing &&
    lhs.timing_exists == rhs.timing_exists &&
    lhs.speeds == rhs.speeds &&
    lhs.speeds_exists == rhs.speeds_exists;
}
...
template <class ContainerAllocator>
struct IsMessage< ::j2735_msgs::MovementEvent_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::j2735_msgs::MovementEvent_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::j2735_msgs::MovementEvent_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::j2735_msgs::MovementEvent_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::j2735_msgs::MovementEvent_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::j2735_msgs::MovementEvent_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::j2735_msgs::MovementEvent_<ContainerAllocator> >
{
  ...
  static const char* value(const ::j2735_msgs::MovementEvent_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x761599329944c7cfULL;
  static const uint64_t static_value2 = 0xb6a4fdf84a54a500ULL;
};

template<class ContainerAllocator>
struct DataType< ::j2735_msgs::MovementEvent_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::j2735_msgs::MovementEvent_<ContainerAllocator> >
{
  static const char* value()
  {
    return "#\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::j2735_msgs::MovementEvent_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      stream.next(m.event_state);
      stream.next(m.timing);
      stream.next(m.timing_exists);
      stream.next(m.speeds);
      stream.next(m.speeds_exists);
    }
...
template<class ContainerAllocator>
struct Printer< ::j2735_msgs::MovementEvent_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::j2735_msgs::MovementEvent_<ContainerAllocator>& v)
  {
    s << indent << "event_state: ";
    s << std::endl;
    Printer< ::j2735_msgs::MovementPhaseState_<ContainerAllocator> >::stream(s, indent + "  ", v.event_state);
    s << indent << "timing: ";
    s << std::endl;
    Printer< ::j2735_msgs::TimeChangeDetails_<ContainerAllocator> >::stream(s, indent + "  ", v.timing);
    s << indent << "timing_exists: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.timing_exists);
    s << indent << "speeds: ";
    s << std::endl;
    Printer< ::j2735_msgs::AdvisorySpeedList_<ContainerAllocator> >::stream(s, indent + "  ", v.speeds);
    s << indent << "speeds_exists: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.speeds_exists);
  }
};
...
#endif // J2735_MSGS_MESSAGE_MOVEMENTEVENT_H
