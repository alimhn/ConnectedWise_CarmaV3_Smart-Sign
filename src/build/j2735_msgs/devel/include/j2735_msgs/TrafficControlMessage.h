// Generated by gencpp from file j2735_msgs/TrafficControlMessage.msg
// DO NOT EDIT!


#ifndef J2735_MSGS_MESSAGE_TRAFFICCONTROLMESSAGE_H
#define J2735_MSGS_MESSAGE_TRAFFICCONTROLMESSAGE_H
...
#include <j2735_msgs/TrafficControlMessageV01.h>
...
{
  typedef TrafficControlMessage_<ContainerAllocator> Type;

  TrafficControlMessage_()
    : choice(0)
    , tcmV01()  {
    }
  TrafficControlMessage_(const ContainerAllocator& _alloc)
    : choice(0)
    , tcmV01(_alloc)  {
  (void)_alloc;
    }
  ...
  _choice_type choice;
   ...
   typedef  ::j2735_msgs::TrafficControlMessageV01_<ContainerAllocator>  _tcmV01_type;
  _tcmV01_type tcmV01;
...
// reducing the odds to have name collisions with Windows.h 
  ...
  #undef RESERVED
#endif
#if defined(_WIN32) && defined(TCMV01)
  #undef TCMV01
#endif
  ...
  typedef boost::shared_ptr< ::j2735_msgs::TrafficControlMessage_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::j2735_msgs::TrafficControlMessage_<ContainerAllocator> const> ConstPtr;

}; // struct TrafficControlMessage_

typedef ::j2735_msgs::TrafficControlMessage_<std::allocator<void> > TrafficControlMessage;

typedef boost::shared_ptr< ::j2735_msgs::TrafficControlMessage > TrafficControlMessagePtr;
typedef boost::shared_ptr< ::j2735_msgs::TrafficControlMessage const> TrafficControlMessageConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::j2735_msgs::TrafficControlMessage_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::j2735_msgs::TrafficControlMessage_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::j2735_msgs::TrafficControlMessage_<ContainerAllocator1> & lhs, const ::j2735_msgs::TrafficControlMessage_<ContainerAllocator2> & rhs)
{
  return lhs.choice == rhs.choice &&
    lhs.tcmV01 == rhs.tcmV01;
}
...
template <class ContainerAllocator>
struct IsMessage< ::j2735_msgs::TrafficControlMessage_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::j2735_msgs::TrafficControlMessage_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::j2735_msgs::TrafficControlMessage_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::j2735_msgs::TrafficControlMessage_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::j2735_msgs::TrafficControlMessage_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::j2735_msgs::TrafficControlMessage_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::j2735_msgs::TrafficControlMessage_<ContainerAllocator> >
{
  ...
  static const char* value(const ::j2735_msgs::TrafficControlMessage_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xedc21843d88fc615ULL;
  static const uint64_t static_value2 = 0x0009ee74c402a652ULL;
};

template<class ContainerAllocator>
struct DataType< ::j2735_msgs::TrafficControlMessage_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::j2735_msgs::TrafficControlMessage_<ContainerAllocator> >
{
  static const char* value()
  {
    return "#\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::j2735_msgs::TrafficControlMessage_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      stream.next(m.choice);
      stream.next(m.tcmV01);
    }
...
template<class ContainerAllocator>
struct Printer< ::j2735_msgs::TrafficControlMessage_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::j2735_msgs::TrafficControlMessage_<ContainerAllocator>& v)
  {
    s << indent << "choice: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.choice);
    s << indent << "tcmV01: ";
    s << std::endl;
    Printer< ::j2735_msgs::TrafficControlMessageV01_<ContainerAllocator> >::stream(s, indent + "  ", v.tcmV01);
  }
};
...
#endif // J2735_MSGS_MESSAGE_TRAFFICCONTROLMESSAGE_H
