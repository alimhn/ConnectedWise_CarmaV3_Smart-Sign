// Generated by gencpp from file j2735_msgs/RoadLaneSetList.msg
// DO NOT EDIT!


#ifndef J2735_MSGS_MESSAGE_ROADLANESETLIST_H
#define J2735_MSGS_MESSAGE_ROADLANESETLIST_H
...
{
  typedef RoadLaneSetList_<ContainerAllocator> Type;

  RoadLaneSetList_()
    : road_lane_set_list()  {
    }
  RoadLaneSetList_(const ContainerAllocator& _alloc)
    : road_lane_set_list(_alloc)  {
  (void)_alloc;
    }



   typedef std::vector< ::j2735_msgs::GenericLane_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::j2735_msgs::GenericLane_<ContainerAllocator> >::other >  _road_lane_set_list_type;
  ...
  typedef boost::shared_ptr< ::j2735_msgs::RoadLaneSetList_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::j2735_msgs::RoadLaneSetList_<ContainerAllocator> const> ConstPtr;

}; // struct RoadLaneSetList_

typedef ::j2735_msgs::RoadLaneSetList_<std::allocator<void> > RoadLaneSetList;

typedef boost::shared_ptr< ::j2735_msgs::RoadLaneSetList > RoadLaneSetListPtr;
typedef boost::shared_ptr< ::j2735_msgs::RoadLaneSetList const> RoadLaneSetListConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::j2735_msgs::RoadLaneSetList_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::j2735_msgs::RoadLaneSetList_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::j2735_msgs::RoadLaneSetList_<ContainerAllocator1> & lhs, const ::j2735_msgs::RoadLaneSetList_<ContainerAllocator2> & rhs)
{
  return lhs.road_lane_set_list == rhs.road_lane_set_list;
}
...
template <class ContainerAllocator>
struct IsMessage< ::j2735_msgs::RoadLaneSetList_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::j2735_msgs::RoadLaneSetList_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::j2735_msgs::RoadLaneSetList_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::j2735_msgs::RoadLaneSetList_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::j2735_msgs::RoadLaneSetList_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::j2735_msgs::RoadLaneSetList_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::j2735_msgs::RoadLaneSetList_<ContainerAllocator> >
{
  ...
  static const char* value(const ::j2735_msgs::RoadLaneSetList_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xe7428b9f82ed8054ULL;
  static const uint64_t static_value2 = 0x25f1b1444faa4165ULL;
};

template<class ContainerAllocator>
struct DataType< ::j2735_msgs::RoadLaneSetList_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::j2735_msgs::RoadLaneSetList_<ContainerAllocator> >
{
  static const char* value()
  {
    return "#\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::j2735_msgs::RoadLaneSetList_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      stream.next(m.road_lane_set_list);
    }
...
template<class ContainerAllocator>
struct Printer< ::j2735_msgs::RoadLaneSetList_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::j2735_msgs::RoadLaneSetList_<ContainerAllocator>& v)
  {
    s << indent << "road_lane_set_list[]" << std::endl;
    for (size_t i = 0; i < v.road_lane_set_list.size(); ++i)
    {
      s << indent << "  road_lane_set_list[" << i << "]: ";
      s << std::endl;
      s << indent;
      Printer< ::j2735_msgs::GenericLane_<ContainerAllocator> >::stream(s, indent + "    ", v.road_lane_set_list[i]);
    }
  }
};
...
#endif // J2735_MSGS_MESSAGE_ROADLANESETLIST_H
