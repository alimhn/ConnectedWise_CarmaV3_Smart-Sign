// Generated by gencpp from file j2735_msgs/NodeListXY.msg
// DO NOT EDIT!


#ifndef J2735_MSGS_MESSAGE_NODELISTXY_H
#define J2735_MSGS_MESSAGE_NODELISTXY_H
...
#include <j2735_msgs/NodeSetXY.h>
#include <j2735_msgs/ComputedLane.h>
...
struct NodeListXY_
{
  typedef NodeListXY_<ContainerAllocator> Type;
  ...
  NodeListXY_(const ContainerAllocator& _alloc)
    : choice(0)
    , nodes(_alloc)
    , computed(_alloc)  {
  (void)_alloc;
  ...
  _choice_type choice;
   ...
   typedef  ::j2735_msgs::NodeSetXY_<ContainerAllocator>  _nodes_type;
  _nodes_type nodes;

   typedef  ::j2735_msgs::ComputedLane_<ContainerAllocator>  _computed_type;
  _computed_type computed;



// reducing the odds to have name collisions with Windows.h 
#if defined(_WIN32) && defined(NODE_SET_XY)
  #undef NODE_SET_XY
#endif
#if defined(_WIN32) && defined(COMPUTED_LANE)
  #undef COMPUTED_LANE
#endif
  ...
  typedef boost::shared_ptr< ::j2735_msgs::NodeListXY_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::j2735_msgs::NodeListXY_<ContainerAllocator> const> ConstPtr;

}; // struct NodeListXY_

typedef ::j2735_msgs::NodeListXY_<std::allocator<void> > NodeListXY;

typedef boost::shared_ptr< ::j2735_msgs::NodeListXY > NodeListXYPtr;
typedef boost::shared_ptr< ::j2735_msgs::NodeListXY const> NodeListXYConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::j2735_msgs::NodeListXY_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::j2735_msgs::NodeListXY_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::j2735_msgs::NodeListXY_<ContainerAllocator1> & lhs, const ::j2735_msgs::NodeListXY_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::j2735_msgs::NodeListXY_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::j2735_msgs::NodeListXY_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::j2735_msgs::NodeListXY_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::j2735_msgs::NodeListXY_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::j2735_msgs::NodeListXY_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::j2735_msgs::NodeListXY_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::j2735_msgs::NodeListXY_<ContainerAllocator> >
{
  ...
  static const char* value(const ::j2735_msgs::NodeListXY_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x1800b634ba1ded6dULL;
  static const uint64_t static_value2 = 0x1de24bb50c1d3ac3ULL;
};

template<class ContainerAllocator>
struct DataType< ::j2735_msgs::NodeListXY_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::j2735_msgs::NodeListXY_<ContainerAllocator> >
{
  static const char* value()
  {
    return "#\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::j2735_msgs::NodeListXY_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      stream.next(m.choice);
      stream.next(m.nodes);
      stream.next(m.computed);
    }
...
template<class ContainerAllocator>
struct Printer< ::j2735_msgs::NodeListXY_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::j2735_msgs::NodeListXY_<ContainerAllocator>& v)
  {
    s << indent << "choice: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.choice);
    s << indent << "nodes: ";
    s << std::endl;
    Printer< ::j2735_msgs::NodeSetXY_<ContainerAllocator> >::stream(s, indent + "  ", v.nodes);
    s << indent << "computed: ";
    s << std::endl;
    Printer< ::j2735_msgs::ComputedLane_<ContainerAllocator> >::stream(s, indent + "  ", v.computed);
  }
};
...
#endif // J2735_MSGS_MESSAGE_NODELISTXY_H
