// Generated by gencpp from file j2735_msgs/MovementList.msg
// DO NOT EDIT!


#ifndef J2735_MSGS_MESSAGE_MOVEMENTLIST_H
#define J2735_MSGS_MESSAGE_MOVEMENTLIST_H
...
#include <j2735_msgs/MovementState.h>
...
{
  typedef MovementList_<ContainerAllocator> Type;

  MovementList_()
    : movement_list()  {
    }
  MovementList_(const ContainerAllocator& _alloc)
    : movement_list(_alloc)  {
  (void)_alloc;
    }



   typedef std::vector< ::j2735_msgs::MovementState_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::j2735_msgs::MovementState_<ContainerAllocator> >::other >  _movement_list_type;
  ...
  typedef boost::shared_ptr< ::j2735_msgs::MovementList_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::j2735_msgs::MovementList_<ContainerAllocator> const> ConstPtr;

}; // struct MovementList_

typedef ::j2735_msgs::MovementList_<std::allocator<void> > MovementList;

typedef boost::shared_ptr< ::j2735_msgs::MovementList > MovementListPtr;
typedef boost::shared_ptr< ::j2735_msgs::MovementList const> MovementListConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::j2735_msgs::MovementList_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::j2735_msgs::MovementList_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::j2735_msgs::MovementList_<ContainerAllocator1> & lhs, const ::j2735_msgs::MovementList_<ContainerAllocator2> & rhs)
{
  return lhs.movement_list == rhs.movement_list;
}
...
template <class ContainerAllocator>
struct IsMessage< ::j2735_msgs::MovementList_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::j2735_msgs::MovementList_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::j2735_msgs::MovementList_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::j2735_msgs::MovementList_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::j2735_msgs::MovementList_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::j2735_msgs::MovementList_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::j2735_msgs::MovementList_<ContainerAllocator> >
{
  ...
  static const char* value(const ::j2735_msgs::MovementList_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xfc3fb3a1c80422deULL;
  static const uint64_t static_value2 = 0x61bd621e777c7b4dULL;
};

template<class ContainerAllocator>
struct DataType< ::j2735_msgs::MovementList_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::j2735_msgs::MovementList_<ContainerAllocator> >
{
  static const char* value()
  {
    return "#\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::j2735_msgs::MovementList_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      stream.next(m.movement_list);
    }
...
template<class ContainerAllocator>
struct Printer< ::j2735_msgs::MovementList_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::j2735_msgs::MovementList_<ContainerAllocator>& v)
  {
    s << indent << "movement_list[]" << std::endl;
    for (size_t i = 0; i < v.movement_list.size(); ++i)
    {
      s << indent << "  movement_list[" << i << "]: ";
      s << std::endl;
      s << indent;
      Printer< ::j2735_msgs::MovementState_<ContainerAllocator> >::stream(s, indent + "    ", v.movement_list[i]);
    }
  }
};
...
#endif // J2735_MSGS_MESSAGE_MOVEMENTLIST_H
