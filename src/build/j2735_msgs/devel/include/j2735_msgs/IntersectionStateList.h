// Generated by gencpp from file j2735_msgs/IntersectionStateList.msg
// DO NOT EDIT!


#ifndef J2735_MSGS_MESSAGE_INTERSECTIONSTATELIST_H
#define J2735_MSGS_MESSAGE_INTERSECTIONSTATELIST_H
...
#include <j2735_msgs/IntersectionState.h>
...
{
  typedef IntersectionStateList_<ContainerAllocator> Type;

  IntersectionStateList_()
    : intersection_state_list()  {
    }
  IntersectionStateList_(const ContainerAllocator& _alloc)
    : intersection_state_list(_alloc)  {
  (void)_alloc;
    }



   typedef std::vector< ::j2735_msgs::IntersectionState_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::j2735_msgs::IntersectionState_<ContainerAllocator> >::other >  _intersection_state_list_type;
  ...
  typedef boost::shared_ptr< ::j2735_msgs::IntersectionStateList_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::j2735_msgs::IntersectionStateList_<ContainerAllocator> const> ConstPtr;

}; // struct IntersectionStateList_

typedef ::j2735_msgs::IntersectionStateList_<std::allocator<void> > IntersectionStateList;

typedef boost::shared_ptr< ::j2735_msgs::IntersectionStateList > IntersectionStateListPtr;
typedef boost::shared_ptr< ::j2735_msgs::IntersectionStateList const> IntersectionStateListConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::j2735_msgs::IntersectionStateList_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::j2735_msgs::IntersectionStateList_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::j2735_msgs::IntersectionStateList_<ContainerAllocator1> & lhs, const ::j2735_msgs::IntersectionStateList_<ContainerAllocator2> & rhs)
{
  return lhs.intersection_state_list == rhs.intersection_state_list;
}
...
template <class ContainerAllocator>
struct IsMessage< ::j2735_msgs::IntersectionStateList_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::j2735_msgs::IntersectionStateList_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::j2735_msgs::IntersectionStateList_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::j2735_msgs::IntersectionStateList_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::j2735_msgs::IntersectionStateList_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::j2735_msgs::IntersectionStateList_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::j2735_msgs::IntersectionStateList_<ContainerAllocator> >
{
  ...
  static const char* value(const ::j2735_msgs::IntersectionStateList_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x3c3e465a240b5941ULL;
  static const uint64_t static_value2 = 0x1de29f191c748f3eULL;
};

template<class ContainerAllocator>
struct DataType< ::j2735_msgs::IntersectionStateList_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::j2735_msgs::IntersectionStateList_<ContainerAllocator> >
{
  static const char* value()
  {
    return "#\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::j2735_msgs::IntersectionStateList_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      stream.next(m.intersection_state_list);
    }
...
template<class ContainerAllocator>
struct Printer< ::j2735_msgs::IntersectionStateList_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::j2735_msgs::IntersectionStateList_<ContainerAllocator>& v)
  {
    s << indent << "intersection_state_list[]" << std::endl;
    for (size_t i = 0; i < v.intersection_state_list.size(); ++i)
    {
      s << indent << "  intersection_state_list[" << i << "]: ";
      s << std::endl;
      s << indent;
      Printer< ::j2735_msgs::IntersectionState_<ContainerAllocator> >::stream(s, indent + "    ", v.intersection_state_list[i]);
    }
  }
};
...
#endif // J2735_MSGS_MESSAGE_INTERSECTIONSTATELIST_H
