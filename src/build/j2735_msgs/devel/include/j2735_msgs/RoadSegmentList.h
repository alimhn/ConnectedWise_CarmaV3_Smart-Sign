// Generated by gencpp from file j2735_msgs/RoadSegmentList.msg
// DO NOT EDIT!


#ifndef J2735_MSGS_MESSAGE_ROADSEGMENTLIST_H
#define J2735_MSGS_MESSAGE_ROADSEGMENTLIST_H
...
#include <j2735_msgs/RoadSegment.h>
...
{
  typedef RoadSegmentList_<ContainerAllocator> Type;

  RoadSegmentList_()
    : road_segment_list()  {
    }
  RoadSegmentList_(const ContainerAllocator& _alloc)
    : road_segment_list(_alloc)  {
  (void)_alloc;
    }



   typedef std::vector< ::j2735_msgs::RoadSegment_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::j2735_msgs::RoadSegment_<ContainerAllocator> >::other >  _road_segment_list_type;
  ...
  typedef boost::shared_ptr< ::j2735_msgs::RoadSegmentList_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::j2735_msgs::RoadSegmentList_<ContainerAllocator> const> ConstPtr;

}; // struct RoadSegmentList_

typedef ::j2735_msgs::RoadSegmentList_<std::allocator<void> > RoadSegmentList;

typedef boost::shared_ptr< ::j2735_msgs::RoadSegmentList > RoadSegmentListPtr;
typedef boost::shared_ptr< ::j2735_msgs::RoadSegmentList const> RoadSegmentListConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::j2735_msgs::RoadSegmentList_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::j2735_msgs::RoadSegmentList_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::j2735_msgs::RoadSegmentList_<ContainerAllocator1> & lhs, const ::j2735_msgs::RoadSegmentList_<ContainerAllocator2> & rhs)
{
  return lhs.road_segment_list == rhs.road_segment_list;
}
...
template <class ContainerAllocator>
struct IsMessage< ::j2735_msgs::RoadSegmentList_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::j2735_msgs::RoadSegmentList_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::j2735_msgs::RoadSegmentList_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::j2735_msgs::RoadSegmentList_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::j2735_msgs::RoadSegmentList_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::j2735_msgs::RoadSegmentList_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::j2735_msgs::RoadSegmentList_<ContainerAllocator> >
{
  ...
  static const char* value(const ::j2735_msgs::RoadSegmentList_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x2db4607d141b80bdULL;
  static const uint64_t static_value2 = 0x6f38916afcdd0403ULL;
};

template<class ContainerAllocator>
struct DataType< ::j2735_msgs::RoadSegmentList_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::j2735_msgs::RoadSegmentList_<ContainerAllocator> >
{
  static const char* value()
  {
    return "#\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::j2735_msgs::RoadSegmentList_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      stream.next(m.road_segment_list);
    }
...
template<class ContainerAllocator>
struct Printer< ::j2735_msgs::RoadSegmentList_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::j2735_msgs::RoadSegmentList_<ContainerAllocator>& v)
  {
    s << indent << "road_segment_list[]" << std::endl;
    for (size_t i = 0; i < v.road_segment_list.size(); ++i)
    {
      s << indent << "  road_segment_list[" << i << "]: ";
      s << std::endl;
      s << indent;
      Printer< ::j2735_msgs::RoadSegment_<ContainerAllocator> >::stream(s, indent + "    ", v.road_segment_list[i]);
    }
  }
};
...
#endif // J2735_MSGS_MESSAGE_ROADSEGMENTLIST_H
