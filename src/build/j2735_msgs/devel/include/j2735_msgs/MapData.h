// Generated by gencpp from file j2735_msgs/MapData.msg
// DO NOT EDIT!


#ifndef J2735_MSGS_MESSAGE_MAPDATA_H
#define J2735_MSGS_MESSAGE_MAPDATA_H
...
#include <j2735_msgs/LayerType.h>
#include <j2735_msgs/IntersectionGeometry.h>
#include <j2735_msgs/RoadSegmentList.h>
#include <j2735_msgs/DataParameters.h>
#include <j2735_msgs/RestrictionClassList.h>
...
struct MapData_
{
  ...
  MapData_()
    ...
    , layer_type()
    , layer_id(0)
    , layer_id_exists(false)
    , intersections()
    , intersections_exists(false)
    , road_segments()
    , road_segments_exists(false)
    , data_parameters()
    , data_parameters_exists(false)
    , restriction_list()
    , restriction_list_exists(false)  {
    }
  MapData_(const ContainerAllocator& _alloc)
    ...
    , intersections_exists(false)
    , road_segments(_alloc)
    , road_segments_exists(false)
    , data_parameters(_alloc)
    , data_parameters_exists(false)
    , restriction_list(_alloc)
    , restriction_list_exists(false)  {
  (void)_alloc;
    }
  ...
  _time_stamp_exists_type time_stamp_exists;
   ...
   typedef uint8_t _msg_issue_revision_type;
  _msg_issue_revision_type msg_issue_revision;

   typedef  ::j2735_msgs::LayerType_<ContainerAllocator>  _layer_type_type;
  _layer_type_type layer_type;

   typedef uint8_t _layer_id_type;
  _layer_id_type layer_id;

   typedef uint8_t _layer_id_exists_type;
  _layer_id_exists_type layer_id_exists;

   typedef std::vector< ::j2735_msgs::IntersectionGeometry_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::j2735_msgs::IntersectionGeometry_<ContainerAllocator> >::other >  _intersections_type;
  _intersections_type intersections;

   typedef uint8_t _intersections_exists_type;
  _intersections_exists_type intersections_exists;

   typedef  ::j2735_msgs::RoadSegmentList_<ContainerAllocator>  _road_segments_type;
  _road_segments_type road_segments;

   typedef uint8_t _road_segments_exists_type;
  _road_segments_exists_type road_segments_exists;

   typedef  ::j2735_msgs::DataParameters_<ContainerAllocator>  _data_parameters_type;
  _data_parameters_type data_parameters;

   typedef uint8_t _data_parameters_exists_type;
  _data_parameters_exists_type data_parameters_exists;

   typedef  ::j2735_msgs::RestrictionClassList_<ContainerAllocator>  _restriction_list_type;
  _restriction_list_type restriction_list;

   typedef uint8_t _restriction_list_exists_type;
  ...
  typedef boost::shared_ptr< ::j2735_msgs::MapData_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::j2735_msgs::MapData_<ContainerAllocator> const> ConstPtr;

}; // struct MapData_

typedef ::j2735_msgs::MapData_<std::allocator<void> > MapData;

typedef boost::shared_ptr< ::j2735_msgs::MapData > MapDataPtr;
typedef boost::shared_ptr< ::j2735_msgs::MapData const> MapDataConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::j2735_msgs::MapData_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::j2735_msgs::MapData_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::j2735_msgs::MapData_<ContainerAllocator1> & lhs, const ::j2735_msgs::MapData_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    ...
    lhs.layer_id_exists == rhs.layer_id_exists &&
    lhs.intersections == rhs.intersections &&
    lhs.intersections_exists == rhs.intersections_exists &&
    lhs.road_segments == rhs.road_segments &&
    lhs.road_segments_exists == rhs.road_segments_exists &&
    lhs.data_parameters == rhs.data_parameters &&
    lhs.data_parameters_exists == rhs.data_parameters_exists &&
    lhs.restriction_list == rhs.restriction_list &&
    lhs.restriction_list_exists == rhs.restriction_list_exists;
}
...
template <class ContainerAllocator>
struct IsMessage< ::j2735_msgs::MapData_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::j2735_msgs::MapData_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::j2735_msgs::MapData_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::j2735_msgs::MapData_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::j2735_msgs::MapData_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::j2735_msgs::MapData_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::j2735_msgs::MapData_<ContainerAllocator> >
{
  ...
  static const char* value(const ::j2735_msgs::MapData_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x4a884ffcbb1d61caULL;
  static const uint64_t static_value2 = 0xcd2b7304877db10bULL;
};

template<class ContainerAllocator>
struct DataType< ::j2735_msgs::MapData_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::j2735_msgs::MapData_<ContainerAllocator> >
{
  static const char* value()
  {
    return "#\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::j2735_msgs::MapData_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      ...
      stream.next(m.msg_issue_revision);
      stream.next(m.layer_type);
      stream.next(m.layer_id);
      stream.next(m.layer_id_exists);
      stream.next(m.intersections);
      stream.next(m.intersections_exists);
      stream.next(m.road_segments);
      stream.next(m.road_segments_exists);
      stream.next(m.data_parameters);
      stream.next(m.data_parameters_exists);
      stream.next(m.restriction_list);
      stream.next(m.restriction_list_exists);
    }
...
template<class ContainerAllocator>
struct Printer< ::j2735_msgs::MapData_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::j2735_msgs::MapData_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    s << indent << "msg_issue_revision: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.msg_issue_revision);
    s << indent << "layer_type: ";
    s << std::endl;
    Printer< ::j2735_msgs::LayerType_<ContainerAllocator> >::stream(s, indent + "  ", v.layer_type);
    s << indent << "layer_id: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.layer_id);
    s << indent << "layer_id_exists: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.layer_id_exists);
    ...
    for (size_t i = 0; i < v.intersections.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::j2735_msgs::IntersectionGeometry_<ContainerAllocator> >::stream(s, indent + "    ", v.intersections[i]);
    }
    s << indent << "intersections_exists: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.intersections_exists);
    s << indent << "road_segments: ";
    s << std::endl;
    Printer< ::j2735_msgs::RoadSegmentList_<ContainerAllocator> >::stream(s, indent + "  ", v.road_segments);
    s << indent << "road_segments_exists: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.road_segments_exists);
    s << indent << "data_parameters: ";
    s << std::endl;
    Printer< ::j2735_msgs::DataParameters_<ContainerAllocator> >::stream(s, indent + "  ", v.data_parameters);
    s << indent << "data_parameters_exists: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.data_parameters_exists);
    s << indent << "restriction_list: ";
    s << std::endl;
    Printer< ::j2735_msgs::RestrictionClassList_<ContainerAllocator> >::stream(s, indent + "  ", v.restriction_list);
    s << indent << "restriction_list_exists: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.restriction_list_exists);
  }
};
...
#endif // J2735_MSGS_MESSAGE_MAPDATA_H
