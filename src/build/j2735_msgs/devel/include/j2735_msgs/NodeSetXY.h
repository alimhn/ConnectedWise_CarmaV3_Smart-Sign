// Generated by gencpp from file j2735_msgs/NodeSetXY.msg
// DO NOT EDIT!


#ifndef J2735_MSGS_MESSAGE_NODESETXY_H
#define J2735_MSGS_MESSAGE_NODESETXY_H
...
struct NodeSetXY_
{
  typedef NodeSetXY_<ContainerAllocator> Type;

  NodeSetXY_()
    : node_set_xy()  {
    }
  NodeSetXY_(const ContainerAllocator& _alloc)
    : node_set_xy(_alloc)  {
  (void)_alloc;
    }
   ...
   typedef std::vector< ::j2735_msgs::NodeXY_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::j2735_msgs::NodeXY_<ContainerAllocator> >::other >  _node_set_xy_type;
  ...
  typedef boost::shared_ptr< ::j2735_msgs::NodeSetXY_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::j2735_msgs::NodeSetXY_<ContainerAllocator> const> ConstPtr;

}; // struct NodeSetXY_

typedef ::j2735_msgs::NodeSetXY_<std::allocator<void> > NodeSetXY;

typedef boost::shared_ptr< ::j2735_msgs::NodeSetXY > NodeSetXYPtr;
typedef boost::shared_ptr< ::j2735_msgs::NodeSetXY const> NodeSetXYConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::j2735_msgs::NodeSetXY_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::j2735_msgs::NodeSetXY_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::j2735_msgs::NodeSetXY_<ContainerAllocator1> & lhs, const ::j2735_msgs::NodeSetXY_<ContainerAllocator2> & rhs)
{
  return lhs.node_set_xy == rhs.node_set_xy;
}
...
template <class ContainerAllocator>
struct IsMessage< ::j2735_msgs::NodeSetXY_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::j2735_msgs::NodeSetXY_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::j2735_msgs::NodeSetXY_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::j2735_msgs::NodeSetXY_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::j2735_msgs::NodeSetXY_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::j2735_msgs::NodeSetXY_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::j2735_msgs::NodeSetXY_<ContainerAllocator> >
{
  ...
  static const char* value(const ::j2735_msgs::NodeSetXY_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xd666523fe355e90aULL;
  static const uint64_t static_value2 = 0x00861ac4c2085728ULL;
};

template<class ContainerAllocator>
struct DataType< ::j2735_msgs::NodeSetXY_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::j2735_msgs::NodeSetXY_<ContainerAllocator> >
{
  static const char* value()
  {
    return "#\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::j2735_msgs::NodeSetXY_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      stream.next(m.node_set_xy);
    }
...
template<class ContainerAllocator>
struct Printer< ::j2735_msgs::NodeSetXY_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::j2735_msgs::NodeSetXY_<ContainerAllocator>& v)
  {
    s << indent << "node_set_xy[]" << std::endl;
    for (size_t i = 0; i < v.node_set_xy.size(); ++i)
    {
      s << indent << "  node_set_xy[" << i << "]: ";
      s << std::endl;
      s << indent;
      Printer< ::j2735_msgs::NodeXY_<ContainerAllocator> >::stream(s, indent + "    ", v.node_set_xy[i]);
    }
  }
};
...
#endif // J2735_MSGS_MESSAGE_NODESETXY_H
