// Generated by gencpp from file j2735_msgs/GenericLane.msg
// DO NOT EDIT!


#ifndef J2735_MSGS_MESSAGE_GENERICLANE_H
#define J2735_MSGS_MESSAGE_GENERICLANE_H
...
#include <j2735_msgs/LaneAttributes.h>
#include <j2735_msgs/AllowedManeuvers.h>
#include <j2735_msgs/NodeListXY.h>
#include <j2735_msgs/ConnectsToList.h>
#include <j2735_msgs/OverlayLaneList.h>
...
struct GenericLane_
{
  typedef GenericLane_<ContainerAllocator> Type;
  ...
  GenericLane_()
    ...
    , name_exists(false)
    , ingress_approach(0)
    , ingress_approach_exists(false)
    , egress_approach(0)
    , egress_approach_exists(false)
    , lane_attributes()
    , maneuvers()
    , maneuvers_exists(false)
    , node_list()
    , connects_to()
    , connects_to_exists(false)
    , overlay_lane_list()
    , overlay_lane_list_exists(false)  {
    }
  GenericLane_(const ContainerAllocator& _alloc)
    : lane_id(0)
    , name(_alloc)
    , name_exists(false)
    , ingress_approach(0)
  ...
  _name_exists_type name_exists;
   ...
   typedef uint8_t _ingress_approach_type;
  _ingress_approach_type ingress_approach;

   typedef uint8_t _ingress_approach_exists_type;
  _ingress_approach_exists_type ingress_approach_exists;

   typedef uint8_t _egress_approach_type;
  _egress_approach_type egress_approach;

   typedef uint8_t _egress_approach_exists_type;
  _egress_approach_exists_type egress_approach_exists;

   typedef  ::j2735_msgs::LaneAttributes_<ContainerAllocator>  _lane_attributes_type;
  _lane_attributes_type lane_attributes;

   typedef  ::j2735_msgs::AllowedManeuvers_<ContainerAllocator>  _maneuvers_type;
  _maneuvers_type maneuvers;

   typedef uint8_t _maneuvers_exists_type;
  _maneuvers_exists_type maneuvers_exists;

   typedef  ::j2735_msgs::NodeListXY_<ContainerAllocator>  _node_list_type;
  _node_list_type node_list;

   typedef  ::j2735_msgs::ConnectsToList_<ContainerAllocator>  _connects_to_type;
  _connects_to_type connects_to;

   typedef uint8_t _connects_to_exists_type;
  _connects_to_exists_type connects_to_exists;

   typedef  ::j2735_msgs::OverlayLaneList_<ContainerAllocator>  _overlay_lane_list_type;
  _overlay_lane_list_type overlay_lane_list;

   typedef uint8_t _overlay_lane_list_exists_type;
  ...
  typedef boost::shared_ptr< ::j2735_msgs::GenericLane_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::j2735_msgs::GenericLane_<ContainerAllocator> const> ConstPtr;

}; // struct GenericLane_

typedef ::j2735_msgs::GenericLane_<std::allocator<void> > GenericLane;

typedef boost::shared_ptr< ::j2735_msgs::GenericLane > GenericLanePtr;
typedef boost::shared_ptr< ::j2735_msgs::GenericLane const> GenericLaneConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::j2735_msgs::GenericLane_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::j2735_msgs::GenericLane_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::j2735_msgs::GenericLane_<ContainerAllocator1> & lhs, const ::j2735_msgs::GenericLane_<ContainerAllocator2> & rhs)
{
  return lhs.lane_id == rhs.lane_id &&
    lhs.name == rhs.name &&
    lhs.name_exists == rhs.name_exists &&
    lhs.ingress_approach == rhs.ingress_approach &&
    lhs.ingress_approach_exists == rhs.ingress_approach_exists &&
    lhs.egress_approach == rhs.egress_approach &&
    lhs.egress_approach_exists == rhs.egress_approach_exists &&
    lhs.lane_attributes == rhs.lane_attributes &&
    lhs.maneuvers == rhs.maneuvers &&
    lhs.maneuvers_exists == rhs.maneuvers_exists &&
    lhs.node_list == rhs.node_list &&
    lhs.connects_to == rhs.connects_to &&
    lhs.connects_to_exists == rhs.connects_to_exists &&
    lhs.overlay_lane_list == rhs.overlay_lane_list &&
    lhs.overlay_lane_list_exists == rhs.overlay_lane_list_exists;
}
...
template <class ContainerAllocator>
struct IsMessage< ::j2735_msgs::GenericLane_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::j2735_msgs::GenericLane_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::j2735_msgs::GenericLane_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::j2735_msgs::GenericLane_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::j2735_msgs::GenericLane_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::j2735_msgs::GenericLane_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::j2735_msgs::GenericLane_<ContainerAllocator> >
{
  ...
  static const char* value(const ::j2735_msgs::GenericLane_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x560d9bfa8f1028b8ULL;
  static const uint64_t static_value2 = 0x63643e101cde5b5eULL;
};

template<class ContainerAllocator>
struct DataType< ::j2735_msgs::GenericLane_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::j2735_msgs::GenericLane_<ContainerAllocator> >
{
  static const char* value()
  {
    return "#\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::j2735_msgs::GenericLane_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      ...
      stream.next(m.ingress_approach);
      stream.next(m.ingress_approach_exists);
      stream.next(m.egress_approach);
      stream.next(m.egress_approach_exists);
      stream.next(m.lane_attributes);
      stream.next(m.maneuvers);
      stream.next(m.maneuvers_exists);
      stream.next(m.node_list);
      stream.next(m.connects_to);
      stream.next(m.connects_to_exists);
      stream.next(m.overlay_lane_list);
      stream.next(m.overlay_lane_list_exists);
    }
...
template<class ContainerAllocator>
struct Printer< ::j2735_msgs::GenericLane_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::j2735_msgs::GenericLane_<ContainerAllocator>& v)
  {
    s << indent << "lane_id: ";
    ...
    s << indent << "ingress_approach: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.ingress_approach);
    s << indent << "ingress_approach_exists: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.ingress_approach_exists);
    s << indent << "egress_approach: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.egress_approach);
    s << indent << "egress_approach_exists: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.egress_approach_exists);
    s << indent << "lane_attributes: ";
    s << std::endl;
    Printer< ::j2735_msgs::LaneAttributes_<ContainerAllocator> >::stream(s, indent + "  ", v.lane_attributes);
    s << indent << "maneuvers: ";
    s << std::endl;
    Printer< ::j2735_msgs::AllowedManeuvers_<ContainerAllocator> >::stream(s, indent + "  ", v.maneuvers);
    s << indent << "maneuvers_exists: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.maneuvers_exists);
    s << indent << "node_list: ";
    s << std::endl;
    Printer< ::j2735_msgs::NodeListXY_<ContainerAllocator> >::stream(s, indent + "  ", v.node_list);
    s << indent << "connects_to: ";
    s << std::endl;
    Printer< ::j2735_msgs::ConnectsToList_<ContainerAllocator> >::stream(s, indent + "  ", v.connects_to);
    s << indent << "connects_to_exists: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.connects_to_exists);
    s << indent << "overlay_lane_list: ";
    s << std::endl;
    Printer< ::j2735_msgs::OverlayLaneList_<ContainerAllocator> >::stream(s, indent + "  ", v.overlay_lane_list);
    s << indent << "overlay_lane_list_exists: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.overlay_lane_list_exists);
  }
};
...
#endif // J2735_MSGS_MESSAGE_GENERICLANE_H
