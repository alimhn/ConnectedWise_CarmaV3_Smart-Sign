// Generated by gencpp from file j2735_msgs/RoadSegment.msg
// DO NOT EDIT!


#ifndef J2735_MSGS_MESSAGE_ROADSEGMENT_H
#define J2735_MSGS_MESSAGE_ROADSEGMENT_H
...
#include <j2735_msgs/RoadSegmentReferenceID.h>
#include <j2735_msgs/Position3D.h>
#include <j2735_msgs/SpeedLimitList.h>
#include <j2735_msgs/RoadLaneSetList.h>
...
struct RoadSegment_
{
  ...
  _name_exists_type name_exists;
   ...
   typedef  ::j2735_msgs::RoadSegmentReferenceID_<ContainerAllocator>  _id_type;
  _id_type id;
  ...
  _speed_limits_exists_type speed_limits_exists;
   ...
   typedef  ::j2735_msgs::RoadLaneSetList_<ContainerAllocator>  _road_lane_set_type;
  ...
  typedef boost::shared_ptr< ::j2735_msgs::RoadSegment_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::j2735_msgs::RoadSegment_<ContainerAllocator> const> ConstPtr;

}; // struct RoadSegment_

typedef ::j2735_msgs::RoadSegment_<std::allocator<void> > RoadSegment;

typedef boost::shared_ptr< ::j2735_msgs::RoadSegment > RoadSegmentPtr;
typedef boost::shared_ptr< ::j2735_msgs::RoadSegment const> RoadSegmentConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::j2735_msgs::RoadSegment_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::j2735_msgs::RoadSegment_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::j2735_msgs::RoadSegment_<ContainerAllocator1> & lhs, const ::j2735_msgs::RoadSegment_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::j2735_msgs::RoadSegment_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::j2735_msgs::RoadSegment_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::j2735_msgs::RoadSegment_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::j2735_msgs::RoadSegment_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::j2735_msgs::RoadSegment_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::j2735_msgs::RoadSegment_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::j2735_msgs::RoadSegment_<ContainerAllocator> >
{
  ...
  static const char* value(const ::j2735_msgs::RoadSegment_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x9299db39f63085d8ULL;
  static const uint64_t static_value2 = 0x59ce33cb3ccd2ca7ULL;
};

template<class ContainerAllocator>
struct DataType< ::j2735_msgs::RoadSegment_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::j2735_msgs::RoadSegment_<ContainerAllocator> >
{
  static const char* value()
  {
    return "#\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::j2735_msgs::RoadSegment_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::j2735_msgs::RoadSegment_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::j2735_msgs::RoadSegment_<ContainerAllocator>& v)
  {
    s << indent << "name: ";
    ...
    s << indent << "id: ";
    s << std::endl;
    Printer< ::j2735_msgs::RoadSegmentReferenceID_<ContainerAllocator> >::stream(s, indent + "  ", v.id);
    s << indent << "revision: ";
    ...
    s << indent << "road_lane_set: ";
    s << std::endl;
    Printer< ::j2735_msgs::RoadLaneSetList_<ContainerAllocator> >::stream(s, indent + "  ", v.road_lane_set);
  }
};
...
#endif // J2735_MSGS_MESSAGE_ROADSEGMENT_H
