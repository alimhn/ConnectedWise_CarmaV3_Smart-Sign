...
struct NovatelPsrdop2_
{
  ...
  _vdop_type vdop;
   ...
   typedef std::vector< ::novatel_gps_msgs::NovatelPsrdop2System_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::novatel_gps_msgs::NovatelPsrdop2System_<ContainerAllocator> >::other >  _systems_type;
