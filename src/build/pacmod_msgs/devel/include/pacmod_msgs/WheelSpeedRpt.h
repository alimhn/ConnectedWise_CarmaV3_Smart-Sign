...
bool operator==(const ::pacmod_msgs::WheelSpeedRpt_<ContainerAllocator1> & lhs, const ::pacmod_msgs::WheelSpeedRpt_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.front_left_wheel_speed == rhs.front_left_wheel_speed &&
    lhs.front_right_wheel_speed == rhs.front_right_wheel_speed &&
    lhs.rear_left_wheel_speed == rhs.rear_left_wheel_speed &&
    lhs.rear_right_wheel_speed == rhs.rear_right_wheel_speed;
}
