...
if(NOT "/workspaces/carma_ws/src/carma-utils/wgs84_utils/include " STREQUAL " ")
  set(wgs84_utils_INCLUDE_DIRS "")
  set(_include_dirs "/workspaces/carma_ws/src/carma-utils/wgs84_utils/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'wgs84_utils' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/workspaces/carma_ws/src/carma-utils/wgs84_utils/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /workspaces/carma_ws/src/build/wgs84_utils/devel/lib;/opt/ros/noetic/lib)
